...
AddonProps::AddonProps(const cp_extension_t *ext)
  ...
  , minversion(ext->plugin->abi_bw_compatibility != NULL ? ext->plugin->abi_bw_compatibility : ext->plugin->version)
...
AddonProps::AddonProps(const cp_plugin_info_t *plugin)
  ...
  , minversion(plugin->abi_bw_compatibility != NULL ? plugin->abi_bw_compatibility : plugin->version)
  , name(plugin->name)
