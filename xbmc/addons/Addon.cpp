...
static const TypeMapping types[] =
  {{"unknown",                           ADDON_UNKNOWN,                 0, "" },
   ...
   {"xbmc.metadata.scraper.library",     ADDON_SCRAPER_LIBRARY,     24083, "DefaultAddonInformationLibraries.png" },
   ...
   {"visualization-library",             ADDON_VIZ_LIBRARY,         24084, "DefaultAddonVisualizationLibrary.png" },
   ...
   {"xbmc.python.module",                ADDON_SCRIPT_MODULE,       24082, "DefaultAddonLibraries.png" },
