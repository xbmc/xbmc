...
static const TypeMapping types[] =
  {{"unknown",                           ADDON_UNKNOWN,                 0, "" },
   ...
   {"xbmc.metadata.scraper.library",     ADDON_SCRAPER_LIBRARY,         0, "DefaultAddonInformationLibraries.png" },
   ...
   {"visualization-library",             ADDON_VIZ_LIBRARY,             0, "DefaultAddonVisualizationLibrary.png" },
   ...
   {"xbmc.python.library",               ADDON_SCRIPT_LIBRARY,      24014, "DefaultAddonHelper.png" },
   {"xbmc.python.module",                ADDON_SCRIPT_MODULE,           0, "DefaultAddonLibraries.png" },
