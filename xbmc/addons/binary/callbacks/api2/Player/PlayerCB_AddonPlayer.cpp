...
void CAddOnPlayer::Init(CB_AddOnLib *callbacks)
{
  callbacks->AddonPlayer.GetSupportedMedia            = CAddOnPlayer::GetSupportedMedia;
  callbacks->AddonPlayer.New                          = CAddOnPlayer::New;
  callbacks->AddonPlayer.Delete                       = CAddOnPlayer::Delete;
  callbacks->AddonPlayer.SetCallbacks                 = CAddOnPlayer::SetCallbacks;
  callbacks->AddonPlayer.PlayFile                     = CAddOnPlayer::PlayFile;
  callbacks->AddonPlayer.PlayFileItem                 = CAddOnPlayer::PlayFileItem;
  callbacks->AddonPlayer.Stop                         = CAddOnPlayer::Stop;
  callbacks->AddonPlayer.Pause                        = CAddOnPlayer::Pause;
  callbacks->AddonPlayer.PlayNext                     = CAddOnPlayer::PlayNext;
  callbacks->AddonPlayer.PlayPrevious                 = CAddOnPlayer::PlayPrevious;
  callbacks->AddonPlayer.PlaySelected                 = CAddOnPlayer::PlaySelected;
  callbacks->AddonPlayer.IsPlaying                    = CAddOnPlayer::IsPlaying;
  callbacks->AddonPlayer.IsPlayingAudio               = CAddOnPlayer::IsPlayingAudio;
  callbacks->AddonPlayer.IsPlayingVideo               = CAddOnPlayer::IsPlayingVideo;
  callbacks->AddonPlayer.IsPlayingRDS                 = CAddOnPlayer::IsPlayingRDS;
  callbacks->AddonPlayer.GetPlayingFile               = CAddOnPlayer::GetPlayingFile;
  callbacks->AddonPlayer.GetTotalTime                 = CAddOnPlayer::GetTotalTime;
  callbacks->AddonPlayer.GetTime                      = CAddOnPlayer::GetTime;
  callbacks->AddonPlayer.SeekTime                     = CAddOnPlayer::SeekTime;
  callbacks->AddonPlayer.GetAvailableVideoStreams     = CAddOnPlayer::GetAvailableVideoStreams;
  callbacks->AddonPlayer.SetVideoStream               = CAddOnPlayer::SetVideoStream;
  callbacks->AddonPlayer.GetAvailableAudioStreams     = CAddOnPlayer::GetAvailableAudioStreams;
  callbacks->AddonPlayer.SetAudioStream               = CAddOnPlayer::SetAudioStream;
  callbacks->AddonPlayer.GetAvailableSubtitleStreams  = CAddOnPlayer::GetAvailableSubtitleStreams;
  callbacks->AddonPlayer.SetSubtitleStream            = CAddOnPlayer::SetSubtitleStream;
  callbacks->AddonPlayer.ShowSubtitles                = CAddOnPlayer::ShowSubtitles;
  callbacks->AddonPlayer.GetCurrentSubtitleName       = CAddOnPlayer::GetCurrentSubtitleName;
  callbacks->AddonPlayer.AddSubtitle                  = CAddOnPlayer::AddSubtitle;
  callbacks->AddonPlayer.ClearList                    = CAddOnPlayer::ClearList;
}

char* CAddOnPlayer::GetSupportedMedia(void* addonData, int mediaType)
{
  try
  {
...
PLAYERHANDLE CAddOnPlayer::New(void *addonData)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks*>(addonData);
...
void CAddOnPlayer::Delete(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::PlayFile(void *addonData, PLAYERHANDLE handle, const char* item, bool windowed)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::PlayFileItem(void *addonData, PLAYERHANDLE handle, const GUIHANDLE listitem, bool windowed)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::PlayList(void *addonData, PLAYERHANDLE handle, const PLAYERHANDLE list, int playListId, bool windowed, int startpos)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::Stop(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::Pause(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::PlayNext(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::PlayPrevious(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::PlaySelected(void *addonData, PLAYERHANDLE handle, int selected)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::IsPlaying(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::IsPlayingAudio(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::IsPlayingVideo(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::IsPlayingRDS(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::GetPlayingFile(void *addonData, PLAYERHANDLE handle, char& file, unsigned int& iMaxStringSize)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
double CAddOnPlayer::GetTotalTime(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
double CAddOnPlayer::GetTime(void *addonData, PLAYERHANDLE handle)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::SeekTime(void *addonData, PLAYERHANDLE handle, double seekTime)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::GetAvailableVideoStreams(void *addonData, PLAYERHANDLE handle, char**& streams, unsigned int& entries)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::SetVideoStream(void *addonData, PLAYERHANDLE handle, int iStream)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::GetAvailableAudioStreams(void *addonData, PLAYERHANDLE handle, char**& streams, unsigned int& entries)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::SetAudioStream(void *addonData, PLAYERHANDLE handle, int iStream)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::GetAvailableSubtitleStreams(void *addonData, PLAYERHANDLE handle, char**& streams, unsigned int& entries)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::SetSubtitleStream(void *addonData, PLAYERHANDLE handle, int iStream)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::ShowSubtitles(void *addonData, PLAYERHANDLE handle, bool bVisible)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
bool CAddOnPlayer::GetCurrentSubtitleName(void *addonData, PLAYERHANDLE handle, char& name, unsigned int& iMaxStringSize)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
...
void CAddOnPlayer::AddSubtitle(void *addonData, PLAYERHANDLE handle, const char* strSubPath)
{
  try
  {
    CAddonCallbacks* helper = static_cast<CAddonCallbacks *>(addonData);
