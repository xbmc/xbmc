...
void CAddOnInfoTagVideo::Init(CB_AddOnLib *callbacks)
{
  callbacks->AddonInfoTagVideo.GetFromPlayer  = CAddOnInfoTagVideo::GetFromPlayer;
  callbacks->AddonInfoTagVideo.Release        = CAddOnInfoTagVideo::Release;
}
