...
void CAddOnDialog_FileBrowser::Init(::V2::KodiAPI::CB_AddOnLib *callbacks)
{
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetDirectory    = CAddOnDialog_FileBrowser::ShowAndGetDirectory;
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetFile         = CAddOnDialog_FileBrowser::ShowAndGetFile;
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetFileFromDir  = CAddOnDialog_FileBrowser::ShowAndGetFileFromDir;
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetFileList     = CAddOnDialog_FileBrowser::ShowAndGetFileList;
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetSource       = CAddOnDialog_FileBrowser::ShowAndGetSource;
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetImage        = CAddOnDialog_FileBrowser::ShowAndGetImage;
  callbacks->GUI.Dialogs.FileBrowser.ShowAndGetImageList    = CAddOnDialog_FileBrowser::ShowAndGetImageList;
  callbacks->GUI.Dialogs.FileBrowser.ClearList              = CAddOnDialog_FileBrowser::ClearList;
}
