...
CAddOnGeneral::CAddOnGeneral()
{
}

void CAddOnGeneral::Init(V2::KodiAPI::CB_AddOnLib *callbacks)
{
  callbacks->General.get_addon_info                 = CAddOnGeneral::get_addon_info;
  callbacks->General.get_setting                    = CAddOnGeneral::get_setting;
  callbacks->General.open_settings_dialog           = CAddOnGeneral::open_settings_dialog;
  callbacks->General.queue_notification             = CAddOnGeneral::queue_notification;
  callbacks->General.queue_notification_from_type   = CAddOnGeneral::queue_notification_from_type;
  callbacks->General.queue_notification_with_image  = CAddOnGeneral::queue_notification_with_image;
  callbacks->General.get_md5                        = CAddOnGeneral::get_md5;
  callbacks->General.unknown_to_utf8                = CAddOnGeneral::unknown_to_utf8;
  callbacks->General.get_localized_string           = CAddOnGeneral::get_localized_string;
  callbacks->General.get_language                   = CAddOnGeneral::get_language;
  callbacks->General.get_dvd_menu_language          = CAddOnGeneral::get_dvd_menu_language;
  callbacks->General.start_server                   = CAddOnGeneral::start_server;
  callbacks->General.audio_suspend                  = CAddOnGeneral::audio_suspend;
  callbacks->General.audio_resume                   = CAddOnGeneral::audio_resume;
  callbacks->General.get_volume                     = CAddOnGeneral::get_volume;
  callbacks->General.set_volume                     = CAddOnGeneral::set_volume;
  callbacks->General.is_muted                       = CAddOnGeneral::is_muted;
  callbacks->General.toggle_mute                    = CAddOnGeneral::toggle_mute;
  callbacks->General.get_optical_state              = CAddOnGeneral::get_optical_state;
  callbacks->General.eject_optical_drive            = CAddOnGeneral::eject_optical_drive;
  callbacks->General.kodi_version                   = CAddOnGeneral::kodi_version;
  callbacks->General.kodi_quit                      = CAddOnGeneral::kodi_quit;
  callbacks->General.htpc_shutdown                  = CAddOnGeneral::htpc_shutdown;
  callbacks->General.htpc_restart                   = CAddOnGeneral::htpc_restart;
  callbacks->General.execute_script                 = CAddOnGeneral::execute_script;
  callbacks->General.execute_builtin                = CAddOnGeneral::execute_builtin;
  callbacks->General.execute_jsonrpc                = CAddOnGeneral::execute_jsonrpc;
  callbacks->General.get_region                     = CAddOnGeneral::get_region;
  callbacks->General.get_free_mem                   = CAddOnGeneral::get_free_mem;
  callbacks->General.get_global_idle_time           = CAddOnGeneral::get_global_idle_time;
  callbacks->General.translate_path                 = CAddOnGeneral::translate_path;
}
...
void CAddOnGeneral::open_settings_dialog(
        void*                     hdl)
{
  try
  {
