...
{
  interfaces->GUI.Window.New                     = CAddOnWindow::New;
  interfaces->GUI.Window.Delete                  = CAddOnWindow::Delete;
  interfaces->GUI.Window.SetCallbacks            = CAddOnWindow::SetCallbacks;
  interfaces->GUI.Window.Show                    = CAddOnWindow::Show;
  interfaces->GUI.Window.Close                   = CAddOnWindow::Close;
  interfaces->GUI.Window.DoModal                 = CAddOnWindow::DoModal;
  interfaces->GUI.Window.SetFocusId              = CAddOnWindow::SetFocusId;
  interfaces->GUI.Window.GetFocusId              = CAddOnWindow::GetFocusId;
  interfaces->GUI.Window.SetProperty             = CAddOnWindow::SetProperty;
  interfaces->GUI.Window.SetPropertyInt          = CAddOnWindow::SetPropertyInt;
  interfaces->GUI.Window.SetPropertyBool         = CAddOnWindow::SetPropertyBool;
  interfaces->GUI.Window.SetPropertyDouble       = CAddOnWindow::SetPropertyDouble;
  interfaces->GUI.Window.GetProperty             = CAddOnWindow::GetProperty;
  interfaces->GUI.Window.GetPropertyInt          = CAddOnWindow::GetPropertyInt;
  interfaces->GUI.Window.GetPropertyBool         = CAddOnWindow::GetPropertyBool;
  interfaces->GUI.Window.GetPropertyDouble       = CAddOnWindow::GetPropertyDouble;
  interfaces->GUI.Window.ClearProperties         = CAddOnWindow::ClearProperties;
  interfaces->GUI.Window.ClearProperty           = CAddOnWindow::ClearProperty;
  interfaces->GUI.Window.GetListSize             = CAddOnWindow::GetListSize;
  interfaces->GUI.Window.ClearList               = CAddOnWindow::ClearList;
  interfaces->GUI.Window.AddItem                 = CAddOnWindow::AddItem;
  interfaces->GUI.Window.AddStringItem           = CAddOnWindow::AddStringItem;
  interfaces->GUI.Window.RemoveItem              = CAddOnWindow::RemoveItem;
  interfaces->GUI.Window.RemoveItemFile          = CAddOnWindow::RemoveItemFile;
  interfaces->GUI.Window.GetListItem             = CAddOnWindow::GetListItem;
  interfaces->GUI.Window.SetCurrentListPosition  = CAddOnWindow::SetCurrentListPosition;
  interfaces->GUI.Window.GetCurrentListPosition  = CAddOnWindow::GetCurrentListPosition;
  interfaces->GUI.Window.SetControlLabel         = CAddOnWindow::SetControlLabel;
  interfaces->GUI.Window.MarkDirtyRegion         = CAddOnWindow::MarkDirtyRegion;

  interfaces->GUI.Window.GetControl_Button       = CAddOnWindow::GetControl_Button;
  interfaces->GUI.Window.GetControl_Edit         = CAddOnWindow::GetControl_Edit;
  interfaces->GUI.Window.GetControl_FadeLabel    = CAddOnWindow::GetControl_FadeLabel;
  interfaces->GUI.Window.GetControl_Image        = CAddOnWindow::GetControl_Image;
  interfaces->GUI.Window.GetControl_Label        = CAddOnWindow::GetControl_Label;
  interfaces->GUI.Window.GetControl_Spin         = CAddOnWindow::GetControl_Spin;
  interfaces->GUI.Window.GetControl_RadioButton  = CAddOnWindow::GetControl_RadioButton;
  interfaces->GUI.Window.GetControl_Progress     = CAddOnWindow::GetControl_Progress;
  interfaces->GUI.Window.GetControl_RenderAddon  = CAddOnWindow::GetControl_RenderAddon;
  interfaces->GUI.Window.GetControl_Slider       = CAddOnWindow::GetControl_Slider;
  interfaces->GUI.Window.GetControl_SettingsSlider= CAddOnWindow::GetControl_SettingsSlider;
  interfaces->GUI.Window.GetControl_TextBox      = CAddOnWindow::GetControl_TextBox;
}


void* CAddOnWindow::New(void *addonData, const char *xmlFilename,
                            const char *defaultSkin, bool forceFallback,
                            bool asDialog)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
    if (!helper)
...
void CAddOnWindow::Delete(void *addonData, void* handle)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::SetCallbacks(void *addonData, void* handle, void* clienthandle,
...
bool CAddOnWindow::Show(void *addonData, void* handle)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
bool CAddOnWindow::Close(void *addonData, void* handle)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
bool CAddOnWindow::DoModal(void *addonData, void* handle)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
bool CAddOnWindow::SetFocusId(void *addonData, void* handle, int iControlId)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
int CAddOnWindow::GetFocusId(void *addonData, void* handle)
{
  int iControlId = -1;
...
void CAddOnWindow::SetProperty(void *addonData, void* handle, const char *key, const char *value)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::SetPropertyInt(void *addonData, void* handle, const char *key, int value)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::SetPropertyBool(void *addonData, void* handle, const char *key, bool value)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::SetPropertyDouble(void *addonData, void* handle, const char *key, double value)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::GetProperty(void *addonData, void* handle, const char *key, char &property, unsigned int &iMaxStringSize)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
int CAddOnWindow::GetPropertyInt(void *addonData, void* handle, const char *key)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
bool CAddOnWindow::GetPropertyBool(void *addonData, void* handle, const char *key)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
double CAddOnWindow::GetPropertyDouble(void *addonData, void* handle, const char *key)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::ClearProperties(void *addonData, void* handle)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::ClearProperty(void *addonData, void* handle, const char *key)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
int CAddOnWindow::GetListSize(void *addonData, void* handle)
{
  try
  {
    if (!handle)
...
void CAddOnWindow::ClearList(void *addonData, void* handle)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::AddItem(void *addonData, void* handle, void* item, int itemPosition)
{
  try
  {
    if (!handle || !item)
...
void* CAddOnWindow::AddStringItem(void *addonData, void* handle, const char *itemName, int itemPosition)
{
  try
  {
    if (!handle || !itemName)
...
void CAddOnWindow::RemoveItem(void *addonData, void* handle, int itemPosition)
{
  try
  {
    if (!handle)
...
void CAddOnWindow::RemoveItemFile(void *addonData, void* handle, void* fileItem)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetListItem(void *addonData, void* handle, int listPos)
{
  try
  {
    CAddonInterfaces* helper = static_cast<CAddonInterfaces*>(static_cast<AddonCB*>(addonData)->addonData);
...
void CAddOnWindow::SetCurrentListPosition(void *addonData, void* handle, int listPos)
{
  try
  {
    if (!handle)
...
int CAddOnWindow::GetCurrentListPosition(void *addonData, void* handle)
{
  try
  {
    if (!handle)
...
void CAddOnWindow::SetControlLabel(void *addonData, void* handle, int controlId, const char *label)
{
  try
  {
    if (!handle)
...
void CAddOnWindow::MarkDirtyRegion(void *addonData, void* handle)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Button(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_FadeLabel(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Label(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Image(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_RadioButton(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Edit(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Progress(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Spin(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_RenderAddon(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_Slider(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_SettingsSlider(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void* CAddOnWindow::GetControl_TextBox(void *addonData, void* handle, int controlId)
{
  try
  {
    if (!handle)
...
void CGUIAddonWindowDialog::Show(bool show /* = true */)
{
  ...
  CApplicationMessenger::GetInstance().SendMsg(TMSG_GUI_ADDON_DIALOG, ADDON_API_LEVEL, show ? 1 : 0, static_cast<void*>(this));
