...
#include "addons/binary/interfaces/api2/GUI/Addon_GUIDialogTextViewer.h"
...
{
  interfaces->GUI.Dialogs.TextViewer.Open = V2::KodiAPI::GUI::CAddOnDialog_TextViewer::Open;
}
