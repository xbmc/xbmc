...
int CAddonGUITranslator::TranslateActionIdToKodi(ADDON_ACTION addonId)
{
  switch (addonId)
  {
    ...
    case ADDON_ACTION_VSHIFT_TOP:
      return ACTION_VSHIFT_TOP;
    case ADDON_ACTION_VSHIFT_CENTER:
      return ACTION_VSHIFT_CENTER;
    case ADDON_ACTION_VSHIFT_BOTTOM:
      return ACTION_VSHIFT_BOTTOM;
    case ADDON_ACTION_VSHIFT_TOP239:
      return ACTION_VSHIFT_TOP239;
    case ADDON_ACTION_VSHIFT_BOTTOM239:
      return ACTION_VSHIFT_BOTTOM239;
