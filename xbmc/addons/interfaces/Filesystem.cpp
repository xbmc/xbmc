...
bool Interface_Filesystem::can_open_directory(void* kodiBase, const char* url)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', url='%p')", __FUNCTION__, static_cast<void*>(addon), url);
    return false;
  }
...
bool Interface_Filesystem::create_directory(void* kodiBase, const char *path)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', path='%p')", __FUNCTION__, static_cast<void*>(addon), path);
    return false;
  }
...
bool Interface_Filesystem::get_directory(void* kodiBase, const char *path, const char* mask, VFSDirEntry** items, unsigned int* num_items)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', path='%p', mask='%p', items='%p', num_items='%p'",
      __FUNCTION__, static_cast<void*>(addon), path, mask, static_cast<void*>(items), static_cast<void*>(num_items));
    return false;
  }
...
void Interface_Filesystem::free_directory(void* kodiBase, VFSDirEntry* items, unsigned int num_items)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', items='%p')", __FUNCTION__, static_cast<void*>(addon), static_cast<void*>(items));
    return;
  }
...
bool Interface_Filesystem::file_exists(void* kodiBase, const char *filename, bool useCache)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', filename='%p')", __FUNCTION__, static_cast<void*>(addon), filename);
    return false;
  }
...
int Interface_Filesystem::stat_file(void* kodiBase, const char *filename, struct __stat64* buffer)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', filename='%p', buffer='%p')", __FUNCTION__, static_cast<void*>(addon), filename, static_cast<void*>(buffer));
    return false;
  }
...
bool Interface_Filesystem::rename_file(void* kodiBase, const char *filename, const char *newFileName)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', filename='%p', newFileName='%p')", __FUNCTION__, static_cast<void*>(addon), filename, newFileName);
    return false;
  }
...
bool Interface_Filesystem::copy_file(void* kodiBase, const char *filename, const char *dest)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', filename='%p', dest='%p')", __FUNCTION__, static_cast<void*>(addon), filename, dest);
    return false;
  }
...
char* Interface_Filesystem::translate_special_protocol(void* kodiBase, const char *strSource)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', strSource='%p)", __FUNCTION__, static_cast<void*>(addon), strSource);
    return nullptr;
  }
...
ssize_t Interface_Filesystem::read_file(void* kodiBase, void* file, void* ptr, size_t size)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', file='%p', ptr='%p')", __FUNCTION__, static_cast<void*>(addon), file, ptr);
    return -1;
  }
...
bool Interface_Filesystem::read_file_string(void* kodiBase, void* file, char *szLine, int lineLength)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', file='%p')", __FUNCTION__, static_cast<void*>(addon), file);
    return false;
  }
...
int Interface_Filesystem::get_file_chunk_size(void* kodiBase, void* file)
{
  ...
  if (addon == nullptr || file == nullptr)
  {
    CLog::Log(LOGERROR, "Interface_VFS::%s - invalid data (addon='%p', file='%p)", __FUNCTION__, static_cast<void*>(addon), file);
    return -1;
  }
...
bool Interface_Filesystem::curl_add_option(void* kodiBase, void* file, int type, const char* name, const char* value)
{
  ...
  {
    CLog::Log(LOGERROR, "Interface_Filesystem::%s - invalid data (addon='%p', file='%p', name='%p', value='%p')", __FUNCTION__, static_cast<void*>(addon), file, name, value);
    return false;
  }
