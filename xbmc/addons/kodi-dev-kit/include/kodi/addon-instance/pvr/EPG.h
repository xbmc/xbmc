...
public:
  ...
  PVREPGTag(const PVREPGTag& epg)
    : CStructHdl(epg),
      ...
      m_parentalRatingSource(epg.m_parentalRatingSource),
  ...
  std::string GetParentalRatingSource() const { return m_parentalRatingSource; }
  ...
  EPG_TAG* GetTag() const
  {
    ...
    m_cStructure->strParentalRatingSource = m_parentalRatingSource.c_str();
...
private:
  ...
  std::string m_parentalRatingSource;
  ...
  void SetData(const EPG_TAG* tag)
  {
    ...
    m_parentalRatingSource =
        tag->strParentalRatingSource == nullptr ? "" : tag->strParentalRatingSource;
