...
//#ifdef API_LEVELS_ACTIVE // Used to prevent old epg header on new libraries
...
#define XBMC_PVR_API_VERSION "4.3.0"

/* min. PVR API version */
#define XBMC_PVR_MIN_API_VERSION "4.3.0"
...
//#ifdef API_LEVELS_ACTIVE
      V2::KodiAPI::kodi_codec_type iCodecType;         /*!< @brief (required) codec type this stream */
      V2::KodiAPI::kodi_codec_id   iCodecId;           /*!< @brief (required) codec id of this stream */
//#else
