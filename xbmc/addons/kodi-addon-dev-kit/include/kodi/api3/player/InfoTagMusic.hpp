...
namespace Player
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_Player_CInfoTagMusic Music Info Tag (class CInfoTagMusic)
  ...
  ///
  /// It has the header \ref InfoTagMusic.hpp "#include <kodi/api3/player/InfoTagMusic.hpp>" be included
  /// to enjoy it.
  ///
  class CInfoTagMusic
  {
  public:
    //==========================================================================
    ///
    /// @ingroup CPP_KodiAPI_Player_CInfoTagMusic
