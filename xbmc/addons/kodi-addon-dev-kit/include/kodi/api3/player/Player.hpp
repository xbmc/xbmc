...
namespace Player
{
  ...
  public:
    ...
    //==========================================================================
    ///
    /// @defgroup CPP_KodiAPI_Player_CPlayer_callbacks Callback functions from Kodi to add-on
    /// \ingroup CPP_KodiAPI_Player_CPlayer
    /// @brief Functions to handle control callbacks from Kodi
    ///
    /// @link CPP_KodiAPI_Player_CPlayer Go back to normal functions from CPP_KodiAPI_Player_CPlayer@endlink
    ///


    //==========================================================================
    ///
    /// @ingroup CPP_KodiAPI_Player_CPlayer_callbacks
    ...
    ///
    /// @ingroup CPP_KodiAPI_Player_CPlayer_callbacks
    /// @brief If the class is used independent (with "new CPP_KodiAPI_Player_CPlayer")
