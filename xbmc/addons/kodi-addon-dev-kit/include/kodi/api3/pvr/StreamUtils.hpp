...
namespace PVR
{
  ...
  /// ~~~~~~~~~~~~~
  ///
  /// It has the header \ref StreamUtils.hpp "#include <kodi/api3/pvr/StreamUtils.hpp>" be included
  /// to enjoy it.
  ///
  ///
  /// ------------------------------------------------------------------------
  ...
  ///  */
  /// #include <kodi/api3/pvr/StreamUtils.hpp>
  ///
  /// KodiAPI::PVR::StreamUtils::CStreamProperties activeChannelStreams;
  /// ...
  /// void UpdateStreams()
  /// {
  ///   CodecDescriptor codecId = KodiAPI::InputStream::CodecDescriptor::GetCodecByName("pcm_f32le");
  ...
  public:
    ...
    ///  * and to alow updates of codec Id's during usage of them.
    ///  */
    /// #include <kodi/api3/pvr/StreamUtils.hpppp>
    ///
    /// KodiAPI::PVR::StreamUtils::CStreamProperties activeChannelStreams;
    /// ...
    /// void UpdateStreams()
    /// {
    ///   KodiAPI::InputStream::CodecDescriptor codecId = KodiAPI::InputStream::CodecDescriptor::GetCodecByName("pcm_f32le");
    ///   if (codecId.Codec().codec_type == XBMC_CODEC_TYPE_AUDIO)
    ///   {
    ///     KodiAPI::PVR::StreamUtils::CPVRStream newStream;
    ///     /* Get the stream data if already present and do only update */
