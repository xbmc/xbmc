...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_CControlRendering Control Rendering
  ...
  ///
  /// It has the header \ref ControlRendering.hpp "#include <kodi/api3/gui/ControlRendering.hpp>"
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_CControlRendering_Defs Definitions, structures and enumerators
  /// \ingroup CPP_KodiAPI_GUI_CControlRendering
