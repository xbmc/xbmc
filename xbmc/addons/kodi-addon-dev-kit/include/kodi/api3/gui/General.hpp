...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_General General
  ...
  ///
  /// It has the header \ref kodi/api3/gui/General.hpp "#include <kodi/api3/gui/General.hpp>" be included
  /// to enjoy it.
  ///
  namespace General
  {
    //==========================================================================
    ///
    /// \ingroup CPP_KodiAPI_GUI_General
