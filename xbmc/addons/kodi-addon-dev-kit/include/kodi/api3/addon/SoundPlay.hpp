...
namespace AddOn
{
  ...
  ///
  /// It has the header \ref SoundPlay.hpp "#include <kodi/addon.api3/SoundPlay.hpp>" be included
  /// to enjoy it.
  ///
  ///
  /// ------------------------------------------------------------------------
  ...
  /// **Example:**
  /// ~~~~~~~~~~~~~{.cpp}
  /// #include <kodi/api3/addon/SoundPlay.hpp>
  /// #include <kodi/api3/gui/DialogFileBrowser.h>
  ///
  /// ...
  ///
