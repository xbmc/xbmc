...
namespace AddOn
{
  ...
  /// **Example:**
  /// ~~~~~~~~~~~~~{.cpp}
  /// #include <kodi/api3/addon/VFSUtils.hpp>
  ///
  ...
  /// ~~~~~~~~~~~~~
  ///
  /// It has the header \ref VFSUtils.hpp "#include <kodi/api3/addon/VFSUtils.hpp>" be included
  /// to enjoy it.
  ///
  class CVFSDirEntry
  {
  ...
  namespace VFSUtils
  {
    ...
    /// #include <kodi/api3/gui/DialogOK.h>
    /// ...
    /// std::string filename;
