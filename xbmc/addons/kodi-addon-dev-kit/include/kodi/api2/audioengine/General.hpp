...
namespace AudioEngine
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_AudioEngine_General
  /// \ingroup CPP_V2_KodiAPI_AudioEngine
  /// @{
  ...
  ///
  /// It has the header \ref PVRLib.h "#include <kodi/api2/audioengine/AudioEngineLib.h>"
  ...
  namespace General
  {
    //============================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_AddOn_General
    ...
    /// <b>Code example:</b>
    /// ~~~~~~~~~~~~~{.cpp}
    /// #include <kodi/api2/audioengine/AudioEngineLib.h>
    ///
    /// ...
