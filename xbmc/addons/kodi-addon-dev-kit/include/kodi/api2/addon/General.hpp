...
namespace AddOn
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_AddOn_General
  /// \ingroup CPP_V2_KodiAPI_AddOn
  /// @{
  ...
  ///
  /// It has the header \ref General.h "#include <kodi/api2/addon/General.h>" be included
  /// to enjoy it.
  ///
  namespace General
  {
    ...
    /// #include <kodi/api2/addon/General.h>
    /// ...
    /// KodiAPI::AddOn::General::QueueNotification(QUEUE_WARNING, "I'm want to inform you, here with a test call to show '%s'", "this");
    /// ...
    /// ~~~~~~~~~~~~~
    ///
