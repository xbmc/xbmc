...
namespace AddOn
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_AddOn_Network
  ...
  ///
  /// It has the header \ref Network.h "#include <kodi/api2/addon/Network.h>" be included
  /// to enjoy it.
  ///
  namespace Network
  {
    //============================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_AddOn_Network
    ...
    /// **Example:**
    /// ~~~~~~~~~~~~~{.cpp}
    /// #include <kodi/api2/addon/Network.h>
    /// ...
    /// std::string strIpAddress = CPP_V2_KodiAPI_AddOn_Network::GetIPAddress();
