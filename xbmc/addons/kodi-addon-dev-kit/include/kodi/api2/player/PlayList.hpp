...
namespace KodiAPI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_Player_CPlayList
  ...
  ///
  /// It has the header \ref PlayList.h "#include <kodi/api2/player/PlayList.h>" be included
  /// to enjoy it.
  ///
  class CPlayList
  {
  public:
    ...
    /// @param[in] index                [opt] integer - position to add playlist item. (default=end)
    ///
    void AddItem(const V2::KodiAPI::GUI::CListItem* listitem, int index = -1);
    //--------------------------------------------------------------------------
    ...
    ///
    V2::KodiAPI::GUI::CListItem* operator[](long i);
    //--------------------------------------------------------------------------
