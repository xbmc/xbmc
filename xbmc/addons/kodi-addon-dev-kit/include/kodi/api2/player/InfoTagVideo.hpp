...
namespace KodiAPI
{
  ...
  ///
  /// \defgroup CPP_V2_KodiAPI_Player_CInfoTagVideo
  ...
  ///
  /// It has the header \ref InfoTagVideo.h "#include <kodi/api2/player/InfoTagVideo.h>" be included
  /// to enjoy it.
  ///
  class CInfoTagVideo
  {
  public:
    //==========================================================================
    ///
    /// @ingroup CPP_V2_KodiAPI_Player_CInfoTagVideo
