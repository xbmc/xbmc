...
namespace PVR
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_PVR_Transfer Transfer
  ...
  ///
  /// It has the header \ref Transfer.hpp "#include <kodi/api2/pvr/Transfer.hpp>" be included
  /// to enjoy it
  ///
  namespace Transfer
  {
    //==========================================================================
    ///
    /// @ingroup CPP_KodiAPI_PVR_Transfer
