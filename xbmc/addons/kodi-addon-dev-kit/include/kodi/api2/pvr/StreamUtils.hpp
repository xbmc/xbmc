...
namespace PVR
{
  ...
  //==========================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_PVR_CPVRStream
  /// \ingroup CPP_V2_KodiAPI_PVR_StreamUtils
  /// @{
  ...
  /// ~~~~~~~~~~~~~
  ///
  /// It has the header \ref StreamUtils.h "#include <kodi/api2/pvr/StreamUtils.h>" be included
  /// to enjoy it.
  ///
  ///
  /// ------------------------------------------------------------------------
  ...
  ///  */
  /// #include <kodi/api2/pvr/StreamUtils.h>
  ///
  /// KodiAPI::PVR::StreamUtils::CStreamProperties activeChannelStreams;
  /// ...
  /// void UpdateStreams()
  /// {
  ///   CodecDescriptor codecId = KodiAPI::AddOn::Codec::CodecDescriptor::GetCodecByName("pcm_f32le");
  ...
  public:
    //==========================================================================
    ///
    /// @ingroup CPP_V2_KodiAPI_PVR_CPVRStream
  ...
  ///
  /// \defgroup CPP_V2_KodiAPI_PVR_CStreamProperties
  /// \ingroup CPP_V2_KodiAPI_PVR_StreamUtils
  /// @{
  ...
  public:
    ///
    /// @ingroup CPP_V2_KodiAPI_PVR_CStreamProperties
    /// @brief Type defination for stream_vector
    ///
    ...
    /// void UpdateStreams()
    /// {
    ///   KodiAPI::Codec::Codec::CodecDescriptor codecId = KodiAPI::AddOn::Codec::CodecDescriptor::GetCodecByName("pcm_f32le");
    ///   if (codecId.Codec().codec_type == XBMC_CODEC_TYPE_AUDIO)
    ///   {
    ///     KodiAPI::PVR::StreamUtils::CPVRStream newStream;
    ///     /* Get the stream data if already present and do only update */
