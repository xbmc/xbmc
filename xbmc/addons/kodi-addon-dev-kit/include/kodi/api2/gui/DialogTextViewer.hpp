...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_DialogTextViewer
  /// \ingroup CPP_V2_KodiAPI_GUI
  /// @{
  /// @brief <b>Text viewer dialog</b>
  ///
  ...
  ///
  /// It has the header \ref DialogTextViewer.h "#include <kodi/api2/gui/DialogTextViewer.h>"
  /// be included to enjoy it.
  ///
  /// \image html help.GUIDialogTextViewer.png
  ///
  namespace DialogTextViewer
  {
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_DialogTextViewer
    ...
    /// **Example:**
    /// ~~~~~~~~~~~~~{.cpp}
    /// #include <kodi/api2/gui/DialogTextViewer.h>
    ///
    /// KodiAPI::GUI::DialogTextViewer::Show("The Wizard of Oz (1939 film)",
