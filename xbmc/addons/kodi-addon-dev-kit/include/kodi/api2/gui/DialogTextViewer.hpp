...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_DialogTextViewer Dialog Text Viewer
  ...
  ///
  /// It has the header \ref DialogTextViewer.hpp "#include <kodi/api2/gui/DialogTextViewer.hpp>"
  ...
  namespace DialogTextViewer
  {
    //==========================================================================
    ///
    /// \ingroup CPP_KodiAPI_GUI_DialogTextViewer
