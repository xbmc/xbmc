...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_DialogYesNo
  ...
  ///
  /// It has the header \ref DialogYesNo.h "#include <kodi/api2/gui/DialogYesNo.h>"
  ...
  namespace DialogYesNo
  {
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_DialogYesNo
    ...
    /// **Example:**
    /// ~~~~~~~~~~~~~{.cpp}
    /// #include <kodi/api2/gui/DialogYesNo.h>
    ///
    /// bool canceled;
