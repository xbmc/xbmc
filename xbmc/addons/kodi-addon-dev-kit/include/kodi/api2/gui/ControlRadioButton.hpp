...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_CControlRadioButton
  ...
  /// controls.
  ///
  /// It has the header \ref ControlRadioButton.h "#include <kodi/api2/gui/ControlRadioButton.h>"
  ...
  public:
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_CControlRadioButton
