...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_DialogFileBrowser
  ...
  ///
  /// It has the header \ref DialogFileBrowser.h "#include <kodi/api2/gui/DialogFileBrowser.h>"
  ...
  namespace DialogFileBrowser
  {
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_DialogFileBrowser
