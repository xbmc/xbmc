...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_CWindow Window
  /// \ingroup CPP_KodiAPI_GUI
  /// @{
  /// @brief <b>Main window control class</b>
  ///
  /// The with  \ref Window.hpp "#include <kodi/api2/gui/Window.hpp>"
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_CWindow_Defs Definitions, structures and enumerators
  /// \ingroup CPP_KodiAPI_GUI_CWindow
  ...
  public:
    ...
    //==========================================================================
    //
    /// @defgroup CPP_KodiAPI_GUI_CWindow_callbacks Callback functions from Kodi to add-on
    /// \ingroup CPP_KodiAPI_GUI_CWindow
    /// @{
    ...
    //==========================================================================
    ///
    /// \ingroup CPP_KodiAPI_GUI_CWindow_callbacks
    /// @brief OnInit method.
    ///
