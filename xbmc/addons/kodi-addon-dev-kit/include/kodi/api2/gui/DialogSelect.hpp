...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_DialogSelect
  ...
  ///
  /// It has the header \ref DialogSelect.h "#include <kodi/api2/gui/DialogSelect.h>"
  ...
  namespace DialogSelect
  {
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_DialogSelect
    ...
    /// **Example:**
    /// ~~~~~~~~~~~~~{.cpp}
    /// #include <kodi/api2/gui/DialogSelect.h>
    ///
