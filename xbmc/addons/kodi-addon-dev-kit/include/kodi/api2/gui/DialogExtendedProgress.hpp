...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_CDialogExtendedProgress
  /// \ingroup CPP_V2_KodiAPI_GUI
  /// @{
  /// @brief <b>Progress dialog shown for background work</b>
  ///
  /// The with \ref DialogExtendedProgress.h "#include <kodi/api2/addon/DialogExtendedProgress.h>"
  ...
  /// **Example:**
  /// ~~~~~~~~~~~~~{.cpp}
  /// #include <kodi/api2/addon/DialogExtendedProgress.h>
  ///
  ...
  public:
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_CDialogExtendedProgress
