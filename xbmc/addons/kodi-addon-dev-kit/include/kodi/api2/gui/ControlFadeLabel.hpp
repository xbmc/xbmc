...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_CControlFadeLabel
  ...
  /// list container.
  ///
  /// It has the header \ref ControlFadeLabel.h "#include <kodi/api2/gui/ControlFadeLabel.h>"
  ...
  public:
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_CControlFadeLabel
