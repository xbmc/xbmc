...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_DialogNumeric
  ...
  ///
  /// It has the header \ref DialogNumeric.h "#include <kodi/api2/gui/DialogNumeric.h>"
  ...
  namespace DialogNumeric
  {
    //==========================================================================
     ///
     /// \ingroup CPP_V2_KodiAPI_GUI_DialogNumeric
    ...
    /// #include <kodi/api2/gui/DialogNumeric.h>
    ///
    /// /*
