...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_CDialogProgress
  /// \ingroup CPP_V2_KodiAPI_GUI
  /// @{
  /// @brief <b>Progress dialog shown in center</b>
  ///
  /// The with #include \ref DialogProgress.h "<kodi/api2/gui/DialogProgress.h>"
  ...
  public:
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_CDialogProgress
