...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_CControlSlider
  ...
  ///
  /// It has the header \ref ControlSlider.h "#include <kodi/api2/gui/ControlSlider.h>"
  ...
  public:
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_CControlSlider
    ...
    ///
    /// The following are the text defination returned from this:
