...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_KodiAPI_GUI_CControlButton Control Button
  ...
  ///
  /// It has the header \ref ControlButton.hpp "#include <kodi/api2/gui/ControlButton.hpp>"
  ...
  public:
    //==========================================================================
    ///
    /// @ingroup CPP_KodiAPI_GUI_CControlButton
