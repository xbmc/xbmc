...
namespace GUI
{
  ...
  ///
  /// It has the header \ref DialogContextMenu.hpp "#include <kodi/api2/gui/DialogContextMenu.hpp>"
  ...
  namespace DialogContextMenu
  {
    ...
    /// };
    ///
    /// int selected = KodiAPI::GUI::DialogContextMenu::Show("Test selection", entries);
    /// if (selected < 0)
