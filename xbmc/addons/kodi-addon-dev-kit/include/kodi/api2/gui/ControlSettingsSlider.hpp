...
namespace GUI
{
  ...
  //============================================================================
  ///
  /// \defgroup CPP_V2_KodiAPI_GUI_CControlSettingsSlider
  ...
  ///
  /// It has the header \ref ControlSettingsSlider.h "#include <kodi/api2/gui/ControlSettingsSlider.h>"
  ...
  public:
    //==========================================================================
    ///
    /// \ingroup CPP_V2_KodiAPI_GUI_CControlSettingsSlider
