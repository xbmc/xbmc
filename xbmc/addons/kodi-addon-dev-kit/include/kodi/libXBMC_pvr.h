...
public:
  ...
  bool RegisterMe(void* handle)
  {
    ...
    PVR_transfer_epg_entry = (void (*)(void* HANDLE, void* CB, const ADDON_HANDLE handle, const V2::KodiAPI::EPG_TAG *epgentry))
   ...
   */
  void TransferEpgEntry(const ADDON_HANDLE handle, const V2::KodiAPI::EPG_TAG* entry)
  {
...
protected:
  ...
  void (*PVR_transfer_epg_entry)(void*, void*, const ADDON_HANDLE, const V2::KodiAPI::EPG_TAG*);
