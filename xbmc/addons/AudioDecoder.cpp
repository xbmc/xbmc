...
{
  m_CodecName = addonInfo->Type(AddonType::ADDON_AUDIODECODER)->GetValue("@name").asString();
  m_strExt = m_CodecName + KODI_ADDON_AUDIODECODER_TRACK_EXT;
  m_hasTags = addonInfo->Type(AddonType::ADDON_AUDIODECODER)->GetValue("@tags").asBoolean();
