...
void CGUIWindowScripts::OnClick(int iItem)
{
  ...
  {
    /*  LOCKSBUG: which set of bookmarks are being accessed here?  commenting out for now...
...
bool CGUIWindowScripts::HaveBookmarkPermissions(CFileItem* pItem, const CStdString &strType)
{
