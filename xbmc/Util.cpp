...
unsigned int CUtil::GetDWord(std::span<char> bytes, unsigned int offset)
{
...
unsigned int CUtil::GetWord(std::span<char> bytes, unsigned int offset)
{
  unsigned int result{0};
...
unsigned int CUtil::GetByte(std::span<char> bytes, unsigned int offset)
{
  return static_cast<unsigned char>(bytes[offset]);
}

std::string CUtil::GetString(std::span<char> bytes, unsigned int offset, unsigned int length)
{
