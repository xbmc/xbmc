...
#define LISTITEM_STARTTIME          (LISTITEM_START + 63)
#define LISTITEM_ENDTIME            (LISTITEM_START + 64)
#define LISTITEM_STARTDATE          (LISTITEM_START + 66)
#define LISTITEM_ENDDATE            (LISTITEM_START + 67)
#define LISTITEM_NEXT_TITLE         (LISTITEM_START + 68)
#define LISTITEM_NEXT_GENRE         (LISTITEM_START + 69)
#define LISTITEM_NEXT_PLOT          (LISTITEM_START + 70)
#define LISTITEM_NEXT_PLOT_OUTLINE  (LISTITEM_START + 71)
#define LISTITEM_NEXT_STARTTIME     (LISTITEM_START + 72)
#define LISTITEM_NEXT_ENDTIME       (LISTITEM_START + 73)
#define LISTITEM_NEXT_STARTDATE     (LISTITEM_START + 74)
#define LISTITEM_NEXT_ENDDATE       (LISTITEM_START + 75)
#define LISTITEM_NEXT_DURATION      (LISTITEM_START + 76)
#define LISTITEM_CHANNEL_NAME       (LISTITEM_START + 77)
#define LISTITEM_CHANNEL_NUMBER     (LISTITEM_START + 78)
#define LISTITEM_CHANNEL_GROUP      (LISTITEM_START + 79)
#define LISTITEM_HASTIMER           (LISTITEM_START + 80)
#define LISTITEM_ISRECORDING        (LISTITEM_START + 81)
#define LISTITEM_ISENCRYPTED        (LISTITEM_START + 82)
#define LISTITEM_PARENTALRATING     (LISTITEM_START + 83)
#define LISTITEM_PROGRESS           (LISTITEM_START + 84)
#define LISTITEM_HAS_EPG            (LISTITEM_START + 85)
