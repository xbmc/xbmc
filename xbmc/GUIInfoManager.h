...
#define LISTITEM_FILENAME_DECODED          (LISTITEM_START + 149)
#define LISTITEM_PATH_DECODED              (LISTITEM_START + 150)
#define LISTITEM_FILENAME_AND_PATH_DECODED (LISTITEM_START + 151)
#define LISTITEM_FOLDERPATH_DECODED        (LISTITEM_START + 152)
#define LISTITEM_FOLDERNAME_DECODED        (LISTITEM_START + 153)
