...
#define VIDEOPLAYER_SHOWID            316
#define VIDEOPLAYER_ACTOR             317
#define VIDEOPLAYER_YEAREPG           318
...
#define LISTITEM_ACTOR              (LISTITEM_START + 146)
#define LISTITEM_YEAREPG            (LISTITEM_START + 147)
#define LISTITEM_SHOWID             (LISTITEM_START + 148)
#define LISTITEM_EPISODENAME        (LISTITEM_START + 149)
