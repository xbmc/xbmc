...
CEpgInfoTag::CEpgInfoTag(CEpg *epg, PVR::CPVRChannelPtr pvrChannel, const string &strTableName /* = StringUtils::EmptyString */, const string &strIconPath /* = StringUtils::EmptyString */) :
    m_bNotify(false),
    m_bChanged(false),
    m_iBroadcastId(-1),
    m_iGenreType(0),
...
void CEpgInfoTag::SetTitle(const string &strTitle)
{
  bool bUpdate(false);
  {
    CSingleLock lock(m_critSection);
...
string CEpgInfoTag::Title(bool bOverrideParental /* = false */) const
{
  string strTitle;
...
void CEpgInfoTag::SetPlotOutline(const string &strPlotOutline)
{
  bool bUpdate(false);
  {
    CSingleLock lock(m_critSection);
...
string CEpgInfoTag::PlotOutline(bool bOverrideParental /* = false */) const
{
  string retVal;
  CSingleLock lock(m_critSection);
...
void CEpgInfoTag::SetPlot(const string &strPlot)
{
  bool bUpdate(false);
  {
    CSingleLock lock(m_critSection);
...
string CEpgInfoTag::Plot(bool bOverrideParental /* = false */) const
{
  string retVal;
  CSingleLock lock(m_critSection);
  if (bOverrideParental || !m_pvrChannel || !g_PVRManager.IsParentalLocked(*m_pvrChannel))
...
void CEpgInfoTag::SetEpisodeName(const string &strEpisodeName)
{
  bool bUpdate(false);
  {
    CSingleLock lock(m_critSection);
...
string CEpgInfoTag::EpisodeName(void) const
{
  string retVal;
  CSingleLock lock(m_critSection);
...
void CEpgInfoTag::SetIcon(const string &strIconPath)
{
  bool bUpdate(false);
  {
    CSingleLock lock(m_critSection);
...
string CEpgInfoTag::Icon(void) const
{
  string retVal;
...
void CEpgInfoTag::SetPath(const string &strFileNameAndPath)
{
  CSingleLock lock(m_critSection);
...
string CEpgInfoTag::Path(void) const
{
  string retVal;
  CSingleLock lock(m_critSection);
...
string CEpgInfoTag::PVRChannelName(void) const
{
  string strReturn;
  CSingleLock lock(m_critSection);
  if (m_pvrChannel)
