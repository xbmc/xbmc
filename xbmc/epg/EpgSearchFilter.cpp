...
void CEpgSearchFilter::Reset()
{
  ...
  m_startDateTime.SetFromUTCDateTime(CServiceBroker::GetEpgContainer().GetFirstEPGDate());
  m_endDateTime.SetFromUTCDateTime(CServiceBroker::GetEpgContainer().GetLastEPGDate());
