...
, { 0x23, 0x0068,      0,    0, 0x48, NULL } // Distinguish ctrl-H from Backspace
, { 0x0f, 0x0009,      0,    0, 0x09, "tab" }
, { 0x17, 0x0069,      0,    0, 0x49, NULL } // Distinguish ctrl-I from Tab
, { 0x1c, 0x000d,      0,    0, 0x0d, "return" }
, { 0x32, 0x006d,      0,    0, 0x4d, NULL } // Distinguish ctrl-M from Return
