...
public:
   ...
   * \param distanceX The absolute x coordinate of motion
   * \param distanceY The absolute y coordinate of motion
   *
   ...
   */
  virtual bool OnPosition(const PointerName& relpointer, int distanceX, int distanceY) = 0;
