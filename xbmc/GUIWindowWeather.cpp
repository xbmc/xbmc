...
void CGUIWindowWeather::UpdateButtons()
{
	...
	SET_CONTROL_LABEL(CONTROL_LABELLOCATION, m_szLocation[m_iCurWeather]);
	SET_CONTROL_LABEL(CONTROL_LABELUPDATED, m_szUpdated);
	...
	SET_CONTROL_LABEL(CONTROL_LABELNOWCOND, m_szNowCond);
	SET_CONTROL_LABEL(CONTROL_LABELNOWTEMP, m_szNowTemp);
	SET_CONTROL_LABEL(CONTROL_LABELNOWFEEL, m_szNowFeel);
	SET_CONTROL_LABEL(CONTROL_LABELNOWUVID, m_szNowUVId);
	SET_CONTROL_LABEL(CONTROL_LABELNOWWIND, m_szNowWind);
	SET_CONTROL_LABEL(CONTROL_LABELNOWDEWP, m_szNowDewp);
	SET_CONTROL_LABEL(CONTROL_LABELNOWHUMI, m_szNowHumd);
	...
	for(int i=0; i<NUM_DAYS; i++)
	{
		SET_CONTROL_LABEL(CONTROL_LABELD0DAY+(i*10), m_dfForcast[i].m_szDay);
		SET_CONTROL_LABEL(CONTROL_LABELD0HI+(i*10), m_dfForcast[i].m_szHigh);
		SET_CONTROL_LABEL(CONTROL_LABELD0LOW+(i*10), m_dfForcast[i].m_szLow);
		SET_CONTROL_LABEL(CONTROL_LABELD0GEN+(i*10), m_dfForcast[i].m_szOverview);
