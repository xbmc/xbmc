...
void CApplication::DelayLoadSkin(const CStdString& strSkin)
{
	m_NewSkin = strSkin;
...
void CApplication::Process()
{
  // checks whats in the DVD drive and tries to autostart the content (xbox games, dvd, cdda, avi files...)
	...
	{
		int iActiveWindow = m_gWindowManager.GetActiveWindow();
		LoadSkin(m_NewSkin);
		m_gWindowManager.ActivateWindow(iActiveWindow);
//		SET_CONTROL_FOCUS(GetID(), CONTROL_SKIN, m_iCurrentSkin > iOldSkin);
	}
