...
bool CPlatformWin32::InitStageOne()
{
  ...
  CEnvironment::setenv("PYTHONHOME", CSpecialProtocol::TranslatePath("special://xbmc/system/python"));

  std::string pyPath = CSpecialProtocol::TranslatePath("special://xbmc/system/python/DLLs");
  pyPath += ";";
  pyPath += CSpecialProtocol::TranslatePath("special://xbmc/system/python/Lib");
  pyPath += ";";
  pyPath += CSpecialProtocol::TranslatePath("special://xbmc/system/python/Lib/site-packages");
