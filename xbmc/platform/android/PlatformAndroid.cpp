...
bool CPlatformAndroid::InitStageOne()
{
  ...
  setenv("LIBBLURAY_CP", CSpecialProtocol::TranslatePath("special://xbmcbin/j2re-image/").c_str(),
         1);

  setenv("LIBBLURAY_CACHE_ROOT",
         CSpecialProtocol::TranslatePath("special://userdata/cache/bluray/cache/").c_str(), 1);
