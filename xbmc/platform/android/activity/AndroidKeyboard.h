...
{
public:
  explicit CAndroidKeyboard(CGUIKeyboard& owner) : m_owner(owner) {}
...
private:
  //! Keyboard shown via CGUIKeyboardFactory; passed to the char callback so that typing resets
  //! its auto-close timer.
  CGUIKeyboard& m_owner;
