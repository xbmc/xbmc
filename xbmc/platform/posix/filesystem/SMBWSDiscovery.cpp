...
CWSDiscoveryPosix::CWSDiscoveryPosix() : m_bIsRunning(false)
{
...
bool CWSDiscoveryPosix::StopServices()
{
  ...
  CLog::Log(LOGINFO, "CWSDiscoveryPosix::StopServices - Stopped");
...
bool CWSDiscoveryPosix::StartServices()
{
  ...
  CLog::Log(LOGINFO, "CWSDiscoveryPosix::StartServices - Started");
