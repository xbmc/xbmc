...
CPlayList* CPlayListFactory::Create(const string& filename)
{
...
CPlayList* CPlayListFactory::Create(const CFileItem& item)
{
  if( item.IsInternetStream() )
  {
    ...
    string strMimeType = item.GetMimeType();
  ...
  string extension = URIUtils::GetExtension(item.GetPath());
...
bool CPlayListFactory::IsPlaylist(const string& filename)
{
