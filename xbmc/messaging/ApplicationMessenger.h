...
#define TMSG_MASK_SCREENSAVER             (1<<25)
...
// unused: TMSG_MASK_APPLICATION + 8
...
#define TMSG_ACTIVATESCREENSAVER          TMSG_MASK_SCREENSAVER + 1
#define TMSG_DEACTIVATESCREENSAVER        TMSG_MASK_SCREENSAVER + 2
#define TMSG_STOPSCREENSAVERTIMER         TMSG_MASK_SCREENSAVER + 3
#define TMSG_RESETSCREENSAVERTIMER        TMSG_MASK_SCREENSAVER + 4
