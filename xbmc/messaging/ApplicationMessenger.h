...
#define TMSG_MASK_PLUGINEXECUTOR          (1<<25)
...
#define TMSG_PLUGIN_EXECUTOR_GET_RESULT   TMSG_MASK_PLUGINEXECUTOR + 0
#define TMSG_PLUGIN_EXECUTOR_STOP_ALL     TMSG_MASK_PLUGINEXECUTOR + 1
...
#define TMSG_PLUGIN_RESULT_READY          TMSG_MASK_APPLICATION + 10
...
#define TMSG_QUEUE_NEXT_ITEM              TMSG_MASK_APPLICATION + 34
