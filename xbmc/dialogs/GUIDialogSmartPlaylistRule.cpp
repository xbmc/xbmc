...
void CGUIDialogSmartPlaylistRule::OnBrowse()
{
  ...
  if (StringUtils::EqualsNoCase(m_type, "movies"))
    basePath += "movies/";
  else if (StringUtils::EqualsNoCase(m_type, "tvshows"))
  {
    type = VIDEODB_CONTENT_TVSHOWS;
    basePath += "tvshows/";
  }
  else if (StringUtils::EqualsNoCase(m_type, "musicvideos"))
  {
    type = VIDEODB_CONTENT_MUSICVIDEOS;
    basePath += "musicvideos/";
  }
  else if (StringUtils::EqualsNoCase(m_type, "episodes"))
  {
  ...
  {
    if (StringUtils::EqualsNoCase(m_type, "tvshows") || StringUtils::EqualsNoCase(m_type, "episodes") || StringUtils::EqualsNoCase(m_type, "movies"))
      videodatabase.GetGenresNav(basePath + "genres/", items, type);
    else if (StringUtils::EqualsNoCase(m_type, "songs") || StringUtils::EqualsNoCase(m_type, "albums") || StringUtils::EqualsNoCase(m_type, "artists") || StringUtils::EqualsNoCase(m_type, "mixed"))
  ...
  else if (m_rule.m_field == FieldWriter)
  {
    ...
    iLabel = 20417;
          ...
          (StringUtils::EqualsNoCase(m_type, "tvshows") && m_rule.m_field == FieldTitle))
  {
  ...
  else if (m_rule.m_field == FieldTitle)
  {
    ...
    else if (StringUtils::EqualsNoCase(m_type, "movies"))
    {
