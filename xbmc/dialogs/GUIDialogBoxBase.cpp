...
CGUIDialogBoxBase::CGUIDialogBoxBase(int id, const string &xmlFile)
...
string CGUIDialogBoxBase::GetLocalized(const CVariant &var) const
{
  if (var.isString())
    return var.asString();
...
string CGUIDialogBoxBase::GetDefaultLabel(int controlId) const
{
