...
#define PVR_ACTUAL_STREAM_CLIENT    (PVR_STRINGS_START + 19)
#define PVR_ACTUAL_STREAM_DEVICE    (PVR_STRINGS_START + 20)
#define PVR_ACTUAL_STREAM_STATUS    (PVR_STRINGS_START + 21)
#define PVR_ACTUAL_STREAM_SIG       (PVR_STRINGS_START + 22)
#define PVR_ACTUAL_STREAM_SNR       (PVR_STRINGS_START + 23)
#define PVR_ACTUAL_STREAM_SIG_PROGR (PVR_STRINGS_START + 24)
#define PVR_ACTUAL_STREAM_SNR_PROGR (PVR_STRINGS_START + 25)
#define PVR_ACTUAL_STREAM_BER       (PVR_STRINGS_START + 26)
#define PVR_ACTUAL_STREAM_UNC       (PVR_STRINGS_START + 27)
#define PVR_ACTUAL_STREAM_VIDEO_BR  (PVR_STRINGS_START + 28)
#define PVR_ACTUAL_STREAM_AUDIO_BR  (PVR_STRINGS_START + 29)
#define PVR_ACTUAL_STREAM_DOLBY_BR  (PVR_STRINGS_START + 30)
#define PVR_ACTUAL_STREAM_CRYPTION  (PVR_STRINGS_START + 31)
#define PVR_ACTUAL_STREAM_SERVICE   (PVR_STRINGS_START + 32)
#define PVR_ACTUAL_STREAM_MUX       (PVR_STRINGS_START + 33)
#define PVR_ACTUAL_STREAM_PROVIDER  (PVR_STRINGS_START + 34)
#define PVR_BACKEND_DISKSPACE_PROGR (PVR_STRINGS_START + 35)
#define PVR_TIMESHIFT_START_TIME    (PVR_STRINGS_START + 36)
#define PVR_TIMESHIFT_END_TIME      (PVR_STRINGS_START + 37)
#define PVR_TIMESHIFT_PLAY_TIME     (PVR_STRINGS_START + 38)
#define PVR_TIMESHIFT_PROGRESS      (PVR_STRINGS_START + 39)
