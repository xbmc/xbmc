    ...
    case NODE_TYPE_EPISODES:
      {
        if (params.GetSeason() > -1)
        {
          ...
          AddSortMethod(SORT_METHOD_VIDEO_USER_RATING, 577, LABEL_MASKS("%E. %T", "%R"));  // Filename, Duration | Foldername, empty
        ...
        else
        {
          ...
          AddSortMethod(SORT_METHOD_VIDEO_USER_RATING, 577, LABEL_MASKS("%H. %T", "%R"));  // Filename, Duration | Foldername, empty
    ...
    case NODE_TYPE_TITLE_MOVIES:
      {
        ...
        else
        {
          ...
          AddSortMethod(SORT_METHOD_VIDEO_USER_RATING, 577, LABEL_MASKS("%T", "%R"));  // Filename, Duration | Foldername, empty
          AddSortMethod(SORT_METHOD_YEAR,562, LABEL_MASKS("%T", "%Y"));
        }
...
CGUIViewStateVideoEpisodes::CGUIViewStateVideoEpisodes(const CFileItemList& items) : CGUIViewStateWindowVideo(items)
{
  ...
  { // format here is tvshowtitle - season/episode number. episode title
    ...
    AddSortMethod(SORT_METHOD_VIDEO_USER_RATING, 577, LABEL_MASKS("%Z - %H. %T", "%R"));  // Filename, Duration | Foldername, empty
