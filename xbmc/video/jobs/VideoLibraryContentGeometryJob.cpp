...
bool IsBusy()
{
  ...
  // Before the player reports playing there is a stretch where a file is being opened and
  // nothing here would notice - long enough to seek a different file across the same share,
  // which is what makes pressing play feel like it has hung.
