...
static const TestEntry TestData[] = {
    ...
    {"foo.S00E01-04S05E03-E06.mkv",
     ...
     {{0, 1}, {0, 4}, {5, 3}, {5, 6}}},
    // expected failure with invalid range(s)
    // if no ranges advanced setting used then each single episode is considered separately
    ...
    {"foo S00E01E03-S01E01.mkv", {}, {{0, 1}, {0, 3}, {1, 1}}}, // invalid range
