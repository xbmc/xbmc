...
void CGUIWindowVideoNav::SelectDefaultItem()
{
  ...
  switch (nodeType)
  {
    ...
    case NodeType::EPISODES:
    {
      ...
      const SelectFirstUnwatchedItem selectFirstUnwatched = GetSettingSelectFirstUnwatchedItem();
      if (selectFirstUnwatched != SelectFirstUnwatchedItem::NEVER)
      {
        ...
        {
          const IncludeAllSeasonsAndSpecials incAllSeasonsSpecials{
              GetSettingIncludeAllSeasonsAndSpecials()};

          const bool bIncludeAllSeasons{
              (incAllSeasonsSpecials == IncludeAllSeasonsAndSpecials::BOTH ||
               incAllSeasonsSpecials == IncludeAllSeasonsAndSpecials::ALL_SEASONS)};
          const bool bIncludeSpecials{
              (incAllSeasonsSpecials == IncludeAllSeasonsAndSpecials::BOTH ||
               incAllSeasonsSpecials == IncludeAllSeasonsAndSpecials::SPECIALS)};

          const int index{GetFirstUnwatchedItemIndex(bIncludeAllSeasons, bIncludeSpecials)};
...
int CGUIWindowVideoNav::GetFirstSelectedItemIndex()
{
