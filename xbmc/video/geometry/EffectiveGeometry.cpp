...
{
  // Wider than what is served by enough to be a different ratio rather than the detector
  // wandering by a row: the vocabulary's neighbouring entries are percent apart, so this
  // separates them without letting jitter through.
