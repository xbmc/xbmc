                             ...
                             const SamplingParams& params)
{
  ...
  // The scan's own window, fed the live exclusion values: one mechanism, so the two paths
  // can only ever differ in the numbers they are given.
                    ...
                    const SamplingParams& params)
{
  ...
  // A shape the answer does not account for, seen once and rightly not trusted - but the only
  // sign that the sampling caught the edge of something. Look again rather than decide.
