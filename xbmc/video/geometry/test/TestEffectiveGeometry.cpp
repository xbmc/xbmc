...
TEST(TestEffectiveGeometry, ARendererDrawingTheWholeFrameAgreesWithPictureRect)
{
  ...
  const CRect fromDrawn = PictureOnScreen(geometry, CRect{0.0f, 0.0f, 3840.0f, 2160.0f}, dest);
...
TEST(TestEffectiveGeometry, ASourceCutToTheContentPutsThePictureEverywhereItIsDrawn)
{
  ...
  ExpectRect(PictureOnScreen(ResolveEffectiveGeometry(inputs),
...
TEST(TestEffectiveGeometry, OnlyTheDrawnPartOfTheContentCounts)
{
  ...
  ExpectRect(PictureOnScreen(ResolveEffectiveGeometry(inputs), CRect{0.0f, 0.0f, 3840.0f, 1080.0f},
...
{
  const CRect dest{0.0f, 0.0f, 1920.0f, 1080.0f};
  ExpectRect(PictureOnScreen(EffectiveGeometry{}, CRect{0.0f, 0.0f, 3840.0f, 2160.0f}, dest), 0.0f,
