...
namespace
{
bool ProcessEpisodeRange(int first,
                         int last,
                         ...
                         const std::string& regex)
{
  ...
  CLog::LogF(LOGDEBUG, "VideoInfoScanner: Return empty as range {}-{} is backwards",
               ...
               static_cast<int>((regexppos = reg.RegFind(remainder.c_str() + offset)) > -1))
        {
              ...
              (regexppos >= 0 && regexp2pos == -1))
          {
            ...
            if (currentSeason == episode.iSeason)
            {
              ...
              if (!ProcessEpisodeRange(next, last, episode, episodeList,
            ...
            else
            {
              ...
              else
              {
                ...
                {
                  CLog::LogF(LOGDEBUG,
                             "VideoInfoScanner: Return empty as invalid range ending in season {}, "
                             "episode {}",
