...
void CGUIDialogVideoSettings::CreateSettings()
{
  ...
  // create our settings
  {
    ...
    entries.push_back(make_pair(VS_INTERLACEMETHOD_DXVA_ADAPTIVE_LOW   , 16320));
    entries.push_back(make_pair(VS_INTERLACEMETHOD_DXVA_ADAPTIVE_MEDIUM, 16321));
    entries.push_back(make_pair(VS_INTERLACEMETHOD_DXVA_ADAPTIVE_HIGH  , 16322));
