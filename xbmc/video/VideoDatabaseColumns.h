...
constexpr int VIDEODB_DETAILS_MOVIE_VERSION_ID          = VIDEODB_DETAILS_MOVIE_TABLE_LAST_ATTR + 24;
constexpr int VIDEODB_DETAILS_MOVIE_VERSION_FILEPATH    = VIDEODB_DETAILS_MOVIE_TABLE_LAST_ATTR + 25;
...
constexpr int VIDEODB_DETAILS_EPISODE_VERSION_FILEPATH  = VIDEODB_DETAILS_EPISODE_TABLE_LAST_ATTR + 21;
...
constexpr int VIDEODB_DETAILS_MUSICVIDEO_VERSION_FILEPATH = VIDEODB_DETAILS_MUSICVIDEO_TABLE_LAST_ATTR + 11;
