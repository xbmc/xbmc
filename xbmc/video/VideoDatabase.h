...
public:
  ...
  bool GetRecentlyAddedMoviesNav(const CStdString& strBaseDir, CFileItemList& items, int limit=0);
  bool GetRecentlyAddedEpisodesNav(const CStdString& strBaseDir, CFileItemList& items, int limit=0);
  bool GetRecentlyAddedMusicVideosNav(const CStdString& strBaseDir, CFileItemList& items, int limit=0);
