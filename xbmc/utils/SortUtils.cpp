...
string ByAlbum(SortAttribute attributes, const SortItem &values)
{
  ...
  string label = StringUtils::Format("%s %s", album.c_str(), ArrayToString(attributes, values.at(FieldArtist)).c_str());
...
{
  string label = ArrayToString(attributes, values.at(FieldArtist));
