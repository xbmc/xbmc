...
public:
  ...
  */
   ...
   * variant subtags have no ISO 639 equivalent. Use it where an ISO 639-2/B contract has to be
   * honoured, and carry the BCP 47 tag otherwise.
   *
   * \note Answers with something whatever it is given. Where the caller needs to know if the
   *       language was recognized at all, ConvertToISO6392B reports it.
   *
   * \param[in] lang The language that should be converted.
  ...
  */
   ...
   *        name.
   *
   * Widening: BCP 47 adds region, script and variant subtags to ISO 639, so nothing is lost. Use
   * it where a language enters the application.
   *
   * \note Answers with something whatever it is given. Where the caller needs to know if the
   *       language was recognized at all, ConvertToBcp47 reports it.
   *
   * \param[in] lang The language that should be converted.
