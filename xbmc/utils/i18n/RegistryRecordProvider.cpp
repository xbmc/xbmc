...
{
  const std::string description = StringUtils::Join(record.m_description, ", ");
  const std::string prefix = StringUtils::Join(record.m_prefix, ", ");

  return fmt::format(
      "Type: {}, Subtag/Tag: {}, Description: {{{}}}, Added: {}, Deprecated: {}, "
      "Preferred-Value: {}, Prefix: {{{}}}, Suppress-Script: {}, Macrolanguage: {}, Scope: {}, "
      "File-Date: {}",
      record.m_type, record.m_subTag, description, record.m_added, record.m_deprecated,
      record.m_preferredValue, prefix, record.m_suppressScript, record.m_macroLanguage,
