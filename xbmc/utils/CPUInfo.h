...
public:
  ...
  const std::string& GetCPUModel() { return m_cpuModel; }
  const std::string& GetCPUBogoMips() { return m_cpuBogoMips; }
  const std::string& GetCPUSoC() { return m_cpuSoC; }
  const std::string& GetCPUHardware() { return m_cpuHardware; }
  const std::string& GetCPURevision() { return m_cpuRevision; }
  const std::string& GetCPUSerial() { return m_cpuSerial; }
