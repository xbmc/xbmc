...
{
  m_SuggestedCharset = StringUtils::ToUpper(documentCharset, StringUtils::GetCLocale());
...
{
  m_SuggestedCharset = StringUtils::ToUpper(dataCharset, StringUtils::GetCLocale());
