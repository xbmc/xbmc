...
#define LOCATION_WEATHER_ID      53 // Weather tower cooperative station number, e.g. "USCA1024"
...
private:
  ...
  CStdString GetJson(const NetworkAccessPoint &ap);
...
XBMC_GLOBAL_REF(CLocation, g_locationManager);
#define g_locationManager XBMC_GLOBAL_USE(CLocation)
