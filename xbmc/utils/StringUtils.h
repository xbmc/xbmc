...
public: // private:
   ...
   */
  static std::u32string FoldCase(const std::u32string_view str);
...
public:
  ...
  static std::string FoldCase(const std::string_view str);
   ...
   * \return Case folded version of str (all lower-case)
   */
  static std::wstring FoldCase(const std::wstring_view str);
