...
public:
   ...
   *         value from a NFO, an addon or as.xml survives a round trip.
   */
   ...
   * \return The tag, or nullopt when the text is not a language. Use this where the answer
   ...
   * \note Media declares "no idea" in both ways, and callers deciding whether they know a
   *       stream's language want them treated alike.
   */
   ...
   *       not. To ask whether two tags name the same language, use Matches.
   */
   ...
   * them affect the answer: en, eng, en-AU and en-GB all name English and so all match. Ask this
   ...
   *       not match und even though IsUndetermined is true of both. Ask that question with
   *       IsUndetermined rather than with this.
   *
   ...
   *
   * Narrowing, as AsIso6392B is: en-AU is named English rather than English (Australia). Ask this
   * where the name is given to something that knows languages but not varieties of them.
   *
