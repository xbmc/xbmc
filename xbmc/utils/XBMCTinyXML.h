...
public:
  ...
  inline const std::string& GetSuggestedCharset(void) const { return m_SuggestedCharset; }
  inline const std::string& GetUsedCharset(void) const      { return m_UsedCharset; }
  static bool Test();
protected:
