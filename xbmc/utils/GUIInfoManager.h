...
#define LISTITEM_STARTTIME          (LISTITEM_START + 53)
#define LISTITEM_ENDTIME            (LISTITEM_START + 54)
#define LISTITEM_CHANNELNUMBER      (LISTITEM_START + 55)
#define LISTITEM_CHANNELNAME        (LISTITEM_START + 56)
#define LISTITEM_ISRECORDING        (LISTITEM_START + 57)
#define LISTITEM_HASTIMER           (LISTITEM_START + 58)
#define LISTITEM_ISENCRYPTED        (LISTITEM_START + 59)
#define LISTITEM_IS_FOLDER          (LISTITEM_START + 60)
