 ...
 *      Author: fbacher
 *
 *  Contains large tables used for validating that case folding
 *  tables were correctly derived.
 */

static const char32_t UnicodeFoldUpperTable[] = {
...
static const char32_t UnicodeFoldLowerTable[] = {
