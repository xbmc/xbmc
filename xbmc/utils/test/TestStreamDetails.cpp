...
TEST(TestStreamDetails, DefaultAudio_CodecAndChannelsComeFromTheFirstStream)
{
  ...
  EXPECT_EQ("jpn", details.GetDefaultAudioLanguage());
  EXPECT_EQ("ac3", details.GetDefaultAudioCodec());
  EXPECT_EQ(2, details.GetDefaultAudioChannels());
...
TEST(TestStreamDetails, DefaultAudio_CodecAndChannelsWhenThereIsNoSuchStream)
{
  ...
  EXPECT_EQ("", none.GetDefaultAudioCodec());
  EXPECT_EQ(-1, none.GetDefaultAudioChannels());
}

TEST(TestStreamDetails, DefaultAudio_UnknownCodecAndChannelsArePassedThrough)
{
  ...
  EXPECT_EQ("", details.GetDefaultAudioLanguage());
  EXPECT_EQ("", details.GetDefaultAudioCodec());
  EXPECT_EQ(0, details.GetDefaultAudioChannels());
}
