...
//! list that is left. A plain refresh, after a fetch, carries nothing.
constexpr unsigned int REFRESH_STANDINGS_INVALIDATED = 1;
...
constexpr auto ACHIEVEMENT_MEASURED_ZERO = "achievement.measuredzero";
