...
#ifndef ACTIVEAE_UTILS_STDSTRING_H_INCLUDED
#define ACTIVEAE_UTILS_STDSTRING_H_INCLUDED
...
#ifndef ACTIVEAE_FILESYSTEM_FILE_H_INCLUDED
#define ACTIVEAE_FILESYSTEM_FILE_H_INCLUDED
