...
*/
  ...
  if (samples != even)
  {
    ...
    else
    {
      ...
      __m64  con = _mm_cvtps_pi8(val);
/*
      ((uint8_t*)&con)[0] = (int16_t)(((int8_t*)&con)[0]) + 127;
      ((uint8_t*)&con)[1] = (int16_t)(((int8_t*)&con)[1]) + 127;
      ((uint8_t*)&con)[2] = (int16_t)(((int8_t*)&con)[2]) + 127;
      ((uint8_t*)&con)[3] = (int16_t)(((int8_t*)&con)[3]) + 127;
*/
      memcpy(dest, &con, odd);
    }
  }
