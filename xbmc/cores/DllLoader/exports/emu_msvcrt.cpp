...
extern "C"
{
  ...
  void* dllmalloc(size_t size)
  {
    ...
    if (!pBlock)
    {
      CLog::Log(LOGSEVERE, "malloc %ld bytes failed, crash imminent", size);
    }
    return pBlock;
  }
  ...
  void* dllcalloc(size_t num, size_t size)
  {
    ...
    if (!pBlock)
    {
      CLog::Log(LOGSEVERE, "calloc %ld bytes failed, crash imminent", size);
    }
    return pBlock;
  }
  ...
  void* dllrealloc( void *memblock, size_t size )
  {
    ...
    if (!pBlock)
    {
      CLog::Log(LOGSEVERE, "realloc %ld bytes failed, crash imminent", size);
    }
    return pBlock;
  }
