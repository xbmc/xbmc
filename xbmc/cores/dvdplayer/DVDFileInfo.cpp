...
bool CDVDFileInfo::DemuxerToStreamDetails(CDVDInputStream *pInputStream, CDVDDemux *pDemux, const std::map<int, DemuxPtr>& pDemuxers, CStreamDetails &details, const CStdString &path)
{
  bool retVal = false;
  details.Reset();
