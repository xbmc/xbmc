...
class CDVDPlayerResampler
{
  public:
    ...
    void AddFloat(DVDAudioFrame &audioframe, double pts);       //add audioframes and resample
    bool RetrieveFloat(DVDAudioFrame &audioframe, double &pts); //get audioframes fromt the samplebuffer
