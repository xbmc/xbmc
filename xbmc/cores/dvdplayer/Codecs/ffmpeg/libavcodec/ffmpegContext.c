...
static MpegEncContext* GetMpegEncContext(struct AVCodecContext* pAVCtx)
{
...
int FFMpeg2DecodeFrame (DXVA_PictureParameters *pPicParams, DXVA_QmatrixData *pQMatrixData, DXVA_SliceInfo *pSliceInfo, int *nSliceCount,
