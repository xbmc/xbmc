...
#define FFMPEG_CONFIGURATION "--extra-cflags='-D_XBOX -fno-common' --disable-shared --enable-memalign-hack --enable-gpl --enable-w32threads --enable-postproc --enable-zlib --enable-static --disable-altivec --disable-muxers --disable-encoders --disable-ipv6 --disable-debug"
