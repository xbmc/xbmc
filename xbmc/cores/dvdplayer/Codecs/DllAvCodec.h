...
public:
  ...
  virtual int av_bitstream_filter_filter(AVBitStreamFilterContext *bsfc, AVCodecContext *avctx,
    const char *args, uint8_t **poutbuf, int *poutbuf_size, const uint8_t *buf, int buf_size, int keyframe) = 0;
  virtual void av_bitstream_filter_close(AVBitStreamFilterContext *bsf) = 0;
...
public:
  ...
  virtual AVBitStreamFilterContext *av_bitstream_filter_init(const char *name)  { ::av_bitstream_filter_init(name); }
  virtual int av_bitstream_filter_filter(AVBitStreamFilterContext *bsfc, AVCodecContext *avctx,
    const char *args, uint8_t **poutbuf, int *poutbuf_size, const uint8_t *buf, int buf_size, int keyframe) { ::av_bitstream_filter_filter(bsfc, avctx, args, poutbuf, poutbuf_size, buf, buf_size, keyframe); }
