...
class DllAvFormat : public DllDynamic, DllAvFormatInterface
{
  ...
  DEFINE_FUNC_ALIGNED2(void, __cdecl, put_byte, ByteIOContext* p1, int p2)
  DEFINE_FUNC_ALIGNED3(void, __cdecl, put_buffer, ByteIOContext* p1, const unsigned char *p2, int p3)
  DEFINE_FUNC_ALIGNED2(void, __cdecl, put_be32, ByteIOContext* p1, unsigned int p2)
  DEFINE_FUNC_ALIGNED2(void, __cdecl, put_be16, ByteIOContext* p1, unsigned int p2)
#else
