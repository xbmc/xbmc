...
unsigned int GetFlagsChromaPosition(unsigned int chroma_position)
{
  ...
  {
    case 1:
      return CONF_FLAGS_CHROMA_LEFT;
    case 2:
      return CONF_FLAGS_CHROMA_CENTER;
    case 3:
      return CONF_FLAGS_CHROMA_TOPLEFT;
  }
  return 0;
}
...
unsigned int GetFlagsColorPrimaries(unsigned int color_primaries)
{
  ...
  {
    case 1:
      return CONF_FLAGS_COLPRI_BT709;
    case 4:
      return CONF_FLAGS_COLPRI_BT470M;
    case 5:
      return CONF_FLAGS_COLPRI_BT470BG;
    case 6:
      return CONF_FLAGS_COLPRI_170M;
    case 7:
      return CONF_FLAGS_COLPRI_240M;
    case 9:
      return CONF_FLAGS_COLPRI_BT2020;
  }
  return 0;
}
