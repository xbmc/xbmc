...
public:
  ...
  virtual DEMUX_ENABLESTREAM_RESULT EnableStream(int iStreamId, bool enable) override;
  virtual DEMUX_ENABLESTREAM_RESULT EnableStreamAtPTS(int iStreamId, uint64_t pts) override;
