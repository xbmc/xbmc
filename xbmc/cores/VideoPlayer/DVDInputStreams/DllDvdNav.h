...
public:
  ...
  virtual dvdnav_status_t dvdnav_open2(dvdnav_t** dest,
                                       ...
                                       const char* path) = 0;
  virtual dvdnav_status_t dvdnav_open_stream(dvdnav_t** dest,
                                             void* stream,
  ...
  virtual dvdnav_status_t dvdnav_set_PGC_positioning_flag(dvdnav_t* self,
                                                          int32_t pgc_based_flag) = 0;
  virtual dvdnav_status_t dvdnav_get_next_cache_block(dvdnav_t* self,
                                                      uint8_t** buf,
                                                      int32_t* event,
                                                      int32_t* len) = 0;
  ...
  virtual dvdnav_status_t dvdnav_current_title_info(dvdnav_t* self,
                                                    int32_t* title,
                                                    int32_t* part) = 0;
  ...
  virtual dvdnav_status_t dvdnav_get_highlight_area(pci_t* nav_pci,
                                                    int32_t button,
                                                    int32_t mode,
  ...
  virtual dvdnav_status_t dvdnav_get_number_of_parts(dvdnav_t* self,
                                                     int32_t title,
                                                     int32_t* parts) = 0;
  ...
  virtual dvdnav_status_t dvdnav_get_audio_attr(dvdnav_t* self,
                                                int32_t streamid,
                                                audio_attr_t* audio_attributes) = 0;
  virtual dvdnav_status_t dvdnav_get_spu_attr(dvdnav_t* self,
                                              int32_t streamid,
                                              subp_attr_t* stitle_attributes) = 0;
  virtual dvdnav_status_t dvdnav_jump_to_sector_by_time(dvdnav_t* self,
                                                        uint64_t offset,
                                                        int32_t origin) = 0;
  virtual int64_t dvdnav_convert_time(dvd_time_t* time) = 0;
  virtual dvdnav_status_t dvdnav_get_angle_info(dvdnav_t* self,
                                                int32_t* current_angle,
                                                int32_t* number_of_angles) = 0;
  virtual dvdnav_status_t dvdnav_angle_change(dvdnav_t* self, int32_t angle) = 0;
  virtual dvdnav_status_t dvdnav_mouse_activate(dvdnav_t* self,
                                                pci_t* pci,
                                                int32_t x,
                                                int32_t y) = 0;
  ...
  virtual uint32_t dvdnav_describe_title_chapters(dvdnav_t* self,
                                                  uint32_t title,
                                                  uint64_t** times,
                                                  uint64_t* duration) = 0;
...
class DllDvdNav : public DllDynamic, DllDvdNavInterface
{
  ...
  DEFINE_METHOD3(dvdnav_status_t,
                 dvdnav_open_stream,
                 (dvdnav_t * *p1, void* p2, dvdnav_stream_cb* p3))
  DEFINE_METHOD4(dvdnav_status_t,
                 dvdnav_open_stream2,
  ...
  DEFINE_METHOD4(dvdnav_status_t,
                 ...
                 (dvdnav_t * p1, uint8_t** p2, int32_t* p3, int32_t* p4))
  ...
  DEFINE_METHOD3(dvdnav_status_t,
                 ...
                 (dvdnav_t * p1, int32_t* p2, int32_t* p3))
  ...
  DEFINE_METHOD4(dvdnav_status_t,
                 ...
                 (pci_t * p1, int32_t p2, int32_t p3, dvdnav_highlight_area_t* p4))
  ...
  DEFINE_METHOD4(dvdnav_status_t,
                 ...
                 (dvdnav_t * p1, pci_t* p2, int32_t p3, int32_t p4))
  DEFINE_METHOD4(dvdnav_status_t,
                 dvdnav_mouse_select,
                 (dvdnav_t * p1, pci_t* p2, int32_t p3, int32_t p4))
  ...
  DEFINE_METHOD4(uint32_t,
                 dvdnav_describe_title_chapters,
                 (dvdnav_t * p1, uint32_t p2, uint64_t** p3, uint64_t* p4))
