...
#define STREAM_PROPERTY_VALUE_INPUTSTREAMFFMPEGARCHIVE  "inputstream.ffmpegarchive" /*!< @brief special value for STREAM_PROPERTY_INPUTSTREAMCLASS to use ffmpeg archive to directly play a stream URL. */
