...
public:
  ...
  {
    if (IsDecStreamTypeFrame())
      return "Frame";
    else if (IsDecStreamTypeStream())
      return "Stream";
    else if (IsDecStreamTypeSingle())
      return "Single";
    else
      return "Unknown";
  }
...
private:
  ...
  std::priority_queue<OrderedBuffer, std::vector<OrderedBuffer>, std::greater<OrderedBuffer>>
