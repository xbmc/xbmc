...
#ifndef __BASEDSRENDERER_H
#define __BASEDSRENDERER_H
#include "streams.h"

// Forward class declarations
class CBaseDsRenderer;
class CBaseDsVideoRenderer;
class CDsRendererInputPin;

// This is our input pin class that channels calls to the renderer

class CDsRendererInputPin : public CBaseInputPin
{
protected:
...
public:
    ...
    CDsRendererInputPin(__inout CBaseDsRenderer *pRenderer,
                      __inout HRESULT *phr,
...
class CBaseDsRenderer : public CBaseFilter
{
protected:
    ...
    CDsRendererInputPin *m_pInputPin;     // Our renderer input pin object
...
public:
    ...
    CBaseDsRenderer(REFCLSID RenderClass, // CLSID for this renderer
...
// CBaseDsVideoRenderer is a renderer class (see its ancestor class) and
...
class CBaseDsVideoRenderer : public CBaseDsRenderer,    // Base renderer class
...
public:
    ...
    CBaseDsVideoRenderer(REFCLSID RenderClass, // CLSID for this renderer
                       __in_opt LPCTSTR pName,         // Debug ONLY description
                       __inout_opt LPUNKNOWN pUnk,       // Aggregated owner object
                       __inout HRESULT *phr);        // General OLE return code

    ~CBaseDsVideoRenderer();
