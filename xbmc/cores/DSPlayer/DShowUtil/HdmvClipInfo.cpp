...
HRESULT CHdmvClipInfo::ReadPlaylist(CStdString strPlaylistFile, REFERENCE_TIME& rtDuration, CAtlList<PlaylistItem>& Playlist)
{
	DWORD				dwPos;
	DWORD				dwTemp;
	...
	CStdString          Path(strPlaylistFile);
...
HRESULT CHdmvClipInfo::FindMainMovie(LPCTSTR strFolder, CStdString& strPlaylistFile, CAtlList<PlaylistItem>& MainPlaylist)
{
	HRESULT				hr		= E_FAIL;
