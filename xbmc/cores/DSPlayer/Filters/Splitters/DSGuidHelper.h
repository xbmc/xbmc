...
public:
  ...
  VIDEOINFOHEADER *CreateVIH(const CDemuxStreamVideo *stream, AVStream *avstream, ULONG *size);
  VIDEOINFOHEADER2 *CreateVIH2(const CDemuxStreamVideo *stream, AVStream *avstream, ULONG *size);
  MPEG1VIDEOINFO *CreateMPEG1VI(const CDemuxStreamVideo *stream, AVStream *avstream, ULONG *size);
  MPEG2VIDEOINFO *CreateMPEG2VI(const CDemuxStreamVideo *stream, AVStream *avstream, ULONG *size, bool is_mpegts_format);
};
