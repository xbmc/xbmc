...
class CNullVideoRendererInputPin : public CDsRendererInputPin, 
								   public IMFGetService,
								   public IDirectXVideoMemoryConfiguration,
								   public IMFVideoDisplayControl
{
public :
    CNullVideoRendererInputPin(CBaseDsRenderer *pRenderer, HRESULT *phr, LPCWSTR Name);
...
private :
  ...
  Com::SmartPtr<IDirect3D9>						m_pD3D;
	...
	Com::SmartPtr<IDirect3DDeviceManager9>		m_pD3DDeviceManager;
	UINT									m_nResetTocken;
	HANDLE									m_hDevice;
	HWND									m_hWnd;
...
CNullVideoRendererInputPin::CNullVideoRendererInputPin(CBaseDsRenderer *pRenderer, HRESULT *phr, LPCWSTR Name)
	: CDsRendererInputPin(pRenderer, phr, Name)
{
	HMODULE		hLib;
...
CNullRenderer::CNullRenderer(REFCLSID clsid, TCHAR* pName, LPUNKNOWN pUnk, HRESULT* phr) 
	: CBaseDsRenderer(clsid, pName, pUnk, phr)
{
}
...
{
#ifdef USE_DXVA
	Com::SmartQIPtr<IMFGetService>		pService = pSample;
	if (pService != NULL)
	{
