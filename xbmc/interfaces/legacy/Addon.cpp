...
namespace XBMCAddon
{
  namespace xbmcaddon
  {
    String Addon::getDefaultId() const { return languageHook == NULL ? emptyString : languageHook->GetAddonId(); }

    String Addon::getAddonVersion() const { return languageHook == NULL ? emptyString : languageHook->GetAddonVersion(); }
