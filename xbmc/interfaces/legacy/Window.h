...
namespace XBMCAddon
{
  namespace xbmcgui
  {
    ...
    public:
      ...
      ///
      /// @param pControl            \ref python_xbmcgui_control "Control" class to focus
      ...
      ///
      /// \ingroup python_xbmcgui_window
      /// @brief \python_func{ setFocusId(int) }
      ///-----------------------------------------------------------------------
      /// Gives the control with the supplied focus.
      ///
      /// @param iControlId          On skin defined id of control
      /// @throws SystemError        On Internal error
      /// @throws RuntimeError       If control is not added to a window
      ///
      setFocusId(...);
      ...
      ///
      /// @param pControl            \ref python_xbmcgui_control "Control" class to remove
      ...
      ///
      /// @param pControls          List with controls to remove
      /// @throws TypeError         If supplied argument is not a \ref python_xbmcgui_control
      ///                           type
      /// @throws RuntimeError      If control is not added to this window
      ///
      ...
      ///
      /// @param pControl               \ref python_xbmcgui_control "Control" to add
      /// @throws TypeError             If supplied argument is not a \ref python_xbmcgui_control
      ///                               type
      ...
      ///
      /// \ingroup python_xbmcgui_window
      /// @brief \python_func{ getControl(int controlId) }
      ///-----------------------------------------------------------------------
      /// Gets the control from this window.
      ///
      /// @param iControlId             \ref python_xbmcgui_control id to get
