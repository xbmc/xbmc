...
namespace XBMCAddon
{
  ...
  Player::Player()
  {
    ...
    ContentGeometry* Player::getContentGeometry()
    {
      ...
      // No playing check, unlike the info tag getters above: at rest this describes the shape
      // Kodi is sitting in, which an automation driving a lens acts on between films too.
