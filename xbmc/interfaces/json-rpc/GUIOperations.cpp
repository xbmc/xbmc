...
JSONRPC_STATUS CGUIOperations::GetProperties(const string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSONRPC_STATUS CGUIOperations::ActivateWindow(const string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSONRPC_STATUS CGUIOperations::ShowNotification(const string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSONRPC_STATUS CGUIOperations::SetFullscreen(const string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSONRPC_STATUS CGUIOperations::SetStereoscopicMode(const string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSONRPC_STATUS CGUIOperations::GetStereoscopicModes(const string &method, ITransportLayer *transport, IClient *client, const CVariant &parameterObject, CVariant &result)
{
...
JSONRPC_STATUS CGUIOperations::GetPropertyValue(const string &property, CVariant &result)
{
  ...
  {
    string skinId = CSettings::Get().GetString("lookandfeel.skin");
    AddonPtr addon;
