  ...
  "{"
    ...
    "\"Playlist.GetItems\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"List.Fields.All\","
    ...
    "\"VideoPlaylist.GetItems\": {"
        ...
        "\"permission\": \"ReadData\","
        "\"params\": ["
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"List.Fields.Video\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
    ...
    "\"AudioLibrary.GetAlbums\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Album\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
    ...
    "\"AudioLibrary.GetSongs\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"genreid\", \"$ref\": \"Library.Id\" },"
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Song\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
    ...
    "\"VideoLibrary.GetMovies\": {"
        ...
        "\"permission\": \"ReadData\","
        "\"params\": ["
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Movie\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
    ...
    "\"VideoLibrary.GetTVShows\": {"
        ...
        "\"permission\": \"ReadData\","
        "\"params\": ["
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.TVShow\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
    ...
    "\"VideoLibrary.GetSeasons\": {"
        ...
        "\"params\": ["
            "{ \"name\": \"tvshowid\", \"$ref\": \"Library.Id\", \"required\": true },"
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Season\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
    ...
    "\"VideoLibrary.GetEpisodes\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Episode\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
                    "\"description\": \"Requesting the cast field will result in increased response times\","
    ...
    "\"VideoLibrary.GetMusicVideos\": {"
        ...
        "\"params\": ["
            "{ \"name\": \"artistid\", \"$ref\": \"Library.Id\" },"
            "{ \"name\": \"albumid\", \"$ref\": \"Library.Id\" },"
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.MusicVideo\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
