...
namespace JSONRPC
{
  ...
  const char* const JSONRPC_SERVICE_VERSION     = "6.5.5";
  ...
  const char* const JSONRPC_SERVICE_TYPES[] = {  
      ...
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
          "\"enum\": [ \"none\", \"label\", \"date\", \"size\", \"file\", \"path\", \"drivetype\", \"title\", \"track\", \"time\", \"artist\","
                    ...
                    "\"bitrate\", \"random\", \"picturecount\", \"face\", \"location\", \"takenon\", \"firstname\", \"lastname\" ]"
        "},"
    ...
    "\"Audio.Details.Media\": {"
      ...
      "}"
    "}",
    "\"Picture.Details.Base\": {"
      "\"extends\": \"Media.Details.Base\","
      "\"properties\": {"
        "\"location\": { \"$ref\": \"Array.String\" }"
      "}"
    "}",
    "\"Picture.Details.Media\": {"
      "\"extends\": \"Picture.Details.Base\","
      "\"properties\": {"
        "\"title\": { \"type\": \"string\" },"
        "\"face\": { \"$ref\": \"Array.String\" },"
        "\"location\": { \"type\": \"string\" },"
        "\"takenon\": { \"type\": \"string\" },"
        "\"year\": { \"type\": \"integer\" },"
        "\"rating\": { \"type\": \"integer\" },"
        "\"locationid\": { \"$ref\": \"Array.Integer\" },"
        "\"faceid\": { \"$ref\": \"Array.Integer\" },"
        "\"displayartist\": { \"type\" : \"string\" }"
      "}"
    "}",
    ...
    "\"Picture.Details.Picture\": {"
      "\"extends\": \"Picture.Details.Media\","
      "\"properties\": {"
        "\"pictureid\": { \"$ref\": \"Library.Id\", \"required\": true },"
        "\"file\": { \"type\": \"string\" },"
        "\"picturetype\": { \"type\": \"string\" },"
        "\"orientation\": { \"type\": \"string\" },"
        "\"albumface\": { \"$ref\": \"Array.String\" },"
        "\"album\": { \"type\": \"string\" },"
        "\"track\": { \"type\": \"integer\" },"
        "\"duration\": { \"type\": \"integer\" },"
        "\"comment\": { \"type\": \"string\" },"
        ...
        "\"takenon\": { \"type\": \"string\" },"
        "\"disc\": { \"type\": \"integer\" },"
        "\"albumfaceid\": { \"$ref\": \"Array.Integer\" }"
      "}"
    "}",
    "\"Picture.Fields.Album\": {"
      "\"extends\": \"Item.Fields.Base\","
      "\"items\": { \"type\": \"string\","
        "\"description\": \"Requesting the locationid and/or faceid field will result in increased response times\","
        "\"enum\": [ \"title\", \"description\", \"face\", \"location\","
                 "\"theme\", \"mood\", \"style\", \"type\", \"albumlabel\","
                 "\"rating\", \"year\", \"fanart\", \"thumbnail\","
                 "\"picturecount\", \"locationid\", \"faceid\", \"displayartist\", \"takenon\" ]"
      "}"
    "}",
    "\"Picture.Fields.Picture\": {"
      "\"extends\": \"Item.Fields.Base\","
      "\"items\": { \"type\": \"string\","
        "\"description\": \"Requesting the locationid, faceid and/or albumfaceid field will result in increased response times\","
        "\"enum\": [ \"title\", \"face\", \"albumface\", \"location\", \"year\","
                  "\"rating\", \"album\", \"track\", \"duration\", \"comment\","
                  "\"lyrics\", \"picturecount\", \"fanart\", \"thumbnail\", \"file\", \"albumid\","
                  "\"lastplayed\", \"disc\", \"locationid\", \"faceid\", \"displayface\","
                  "\"albumfaceid\", \"takenon\" ]"
      "}"
    "}",
    ...
    "\"Contact.Fields.Name\": {"
      ...
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
          "\"enum\": [ \"first\", \"middle\", \"last\", \"nick\", \"prefix\", \"suffix\", \"note\", \"thumbnail\" ]"
        "}"
      "}"
    "}",
    "\"Contact.Fields.Profession\": {"
      "\"type\": \"object\","
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
          "\"enum\": [ \"organization\", \"title\", \"department\"]"
        "}"
      "}"
    "}",
    "\"Contact.Fields.Dates\": {"
      "\"type\": \"object\","
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
    ...
    "\"Contact.Fields.Emails\": {"
      ...
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
          "\"enum\": [ \"email1\", \"email2\", \"email3\", \"email5\", \"email4\" ]"
        "}"
      "}"
    "}",
    "\"Contact.Fields.Address\": {"
      ...
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
          "\"enum\": [ \"type\", \"houseno\", \"floor\", \"street\", \"city\", \"state\", \"zip\", \"country\", \"countrycode\" ]"
        "}"
      "}"
    "}",
    "\"Contact.Fields.Relations\": {"
      "\"type\": \"object\","
      "\"properties\": {"
        "\"method\": { \"type\": \"string\", \"default\": \"none\","
          "\"enum\": [ \"mother\", \"father\", \"mother-in-law\", \"father-in-law\", \"son\", \"daughter\", \"wife\" ]"
        "}"
      "}"
    "}",
    
    "\"Picture.Details.Album\": {"
      "\"extends\": \"Picture.Details.Media\","
      "\"properties\": {"
        "\"albumid\": { \"$ref\": \"Library.Id\", \"required\": true },"
        "\"description\": { \"type\": \"string\" },"
    ...
    "\"List.Filter.Rule.Songs\": {"
      ...
      "}"
    "}",
    "\"List.Filter.Rule.Pictures\": {"
      "\"extends\": \"List.Filter.Rule\","
      "\"properties\": {"
        "\"field\": { \"$ref\": \"List.Filter.Fields.Pictures\", \"required\": true }"
      "}"
    "}",
    "\"List.Filter.Rule.Contacts\": {"
      "\"extends\": \"List.Filter.Rule\","
      "\"properties\": {"
        "\"field\": { \"$ref\": \"List.Filter.Fields.Contacts\", \"required\": true }"
      "}"
    "}",
    "\"List.Filter.Movies\": {"
      "\"type\": ["
    ...
    "\"List.Filter.Songs\": {"
      ...
      "]"
    "}",
    "\"List.Filter.Pictures\": {"
      "\"type\": ["
        "{ \"type\": \"object\","
          "\"properties\": {"
            "\"and\": { \"type\": \"array\","
              "\"items\": { \"$ref\": \"List.Filter.Pictures\" },"
              "\"minItems\": 1, \"required\": true"
            "}"
          "}"
        "},"
    ...
    "}",
      ...
      "\"type\": ["
        "{ \"type\": \"object\","
          "\"properties\": {"
            "\"and\": { \"type\": \"array\","
              "\"items\": { \"$ref\": \"List.Filter.Contacts\" },"
              "\"minItems\": 1, \"required\": true"
            "}"
          "}"
        "},"
  ...
  const char* const JSONRPC_SERVICE_METHODS[] = {  
    ...
    "\"JSONRPC.NotifyAll\": {"
      ...
      "\"returns\": \"any\""
    "}",
    "\"PictureLibrary.GetPictureAlbums\": {"
        "\"type\": \"method\","
        "\"description\": \"Retrieve all albums from specified face or location\","
        "\"transport\": \"Response\","
        "\"permission\": \"ReadData\","
        "\"params\": ["
                   "{ \"name\": \"properties\", \"$ref\": \"Picture.Fields.Album\" },"
                   "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
                   "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" },"
                   "{ \"name\": \"filter\","
                   "\"type\": ["
                            "{ \"type\": \"object\", \"properties\": { \"locationid\": { \"$ref\": \"Library.Id\", \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"location\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"picturetype\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"faceid\": { \"$ref\": \"Library.Id\", \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"face\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
        ...
        "\"returns\": {"
            ...
            "\"properties\": {"
                "\"limits\": { \"$ref\": \"List.LimitsReturned\", \"required\": true },"
                "\"albums\": { \"type\": \"array\","
                    "\"items\": { \"$ref\": \"Picture.Details.Album\" }"
                "}"
            "}"
        "}"
    "}",
    "\"PictureLibrary.GetPictureAlbumDetails\": {"
        "\"type\": \"method\","
        ...
        "\"returns\": { \"type\": \"object\","
            "\"properties\": {"
                "\"albumdetails\": { \"$ref\": \"Picture.Details.Album\" }"
            "}"
        "}"
    "}",
    "\"PictureLibrary.AddPictureAlbum\": {"
        "\"type\": \"method\","
        "\"description\": \"Retrieve all albums from specified face or location\","
        "\"transport\": \"Response\","
        "\"permission\": \"UpdateData\","
        "\"params\": ["
              "{ \"name\": \"title\", \"type\": \"string\", \"required\": true, \"description\": \"Required for album title\"},"
                   "{ \"name\": \"properties\", \"$ref\": \"Picture.Fields.Album\" },"
                   "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
                   "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" },"
                   "{ \"name\": \"filter\","
    ...
    "\"PictureLibrary.AddPicture\": {"
      "\"type\": \"method\","
      "\"description\": \"Add a picture with the given details\","
      "\"transport\": \"Response\","
      "\"permission\": \"UpdateData\","
      "\"params\": ["
              ...
              "{ \"name\": \"location\", \"type\": \"string\", \"required\": false, \"description\": \"Required for album title to add to\"},"
              "{ \"name\": \"takenon\", \"type\": \"string\", \"required\": false, \"description\": \"Required for album title to add to\"},"
              "{ \"name\": \"faces\", \"type\": \"array\", \"required\": false, \"description\": \"Required for album title to add to\"},"
                   "{ \"name\": \"properties\", \"$ref\": \"Picture.Fields.Picture\" },"
                   "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
                   "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" },"
                   "{ \"name\": \"filter\","
                   "\"type\": ["
                            "{ \"type\": \"object\", \"properties\": { \"locationid\": { \"$ref\": \"Library.Id\", \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"location\": { \"type\": \"string\", \"minLength\": 1, \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"picturetype\": { \"type\": \"string\", \"minLength\": 1, \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"faceid\": { \"$ref\": \"Library.Id\", \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"face\": { \"type\": \"string\", \"minLength\": 1, \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"albumid\": { \"$ref\": \"Library.Id\", \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"album\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"title\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"takenon\": { \"type\": \"string\", \"minLength\": 1, \"required\": false } }, \"additionalProperties\": false },"
                            "{ \"$ref\": \"List.Filter.Pictures\" }"
                  "]"
          "}"
            "],"
        "\"returns\": { \"type\": \"object\","
            "\"properties\": {"
                "\"picturedetails\": { \"$ref\": \"Picture.Details.Picture\" }"
            "}"
       "}"
    "}",
  
    "\"PictureLibrary.GetPictures\": {"
        "\"type\": \"method\","
        "\"description\": \"Retrieve all pictures from specified album, face or location\","
        "\"transport\": \"Response\","
        "\"permission\": \"ReadData\","
        "\"params\": ["
                   "{ \"name\": \"properties\", \"$ref\": \"Picture.Fields.Picture\" },"
                   ...
                   "\"type\": ["
                            ...
                            "{ \"type\": \"object\", \"properties\": { \"faceid\": { \"$ref\": \"Library.Id\", \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"face\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"orientation\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"albumid\": { \"$ref\": \"Library.Id\", \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"type\": \"object\", \"properties\": { \"album\": { \"type\": \"string\", \"minLength\": 1, \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"$ref\": \"List.Filter.Pictures\" }"
                            "]"
        ...
        "\"returns\": {"
            ...
            "\"properties\": {"
                "\"limits\": { \"$ref\": \"List.LimitsReturned\", \"required\": true },"
                "\"pictures\": { \"type\": \"array\","
                    "\"items\": { \"$ref\": \"Picture.Details.Picture\" }"
                "}"
            "}"
        "}"
    "}",
    "\"PictureLibrary.GetPictureDetails\": {"
        "\"type\": \"method\","
        "\"description\": \"Retrieve details about a specific picture\","
        "\"transport\": \"Response\","
        "\"permission\": \"ReadData\","
        "\"params\": ["
                   "{ \"name\": \"pictureid\", \"$ref\": \"Library.Id\", \"required\": true },"
                   "{ \"name\": \"properties\", \"$ref\": \"Picture.Fields.Picture\" }"
                   "],"
        "\"returns\": { \"type\": \"object\","
            "\"properties\": {"
    ...
    "\"PictureLibrary.GetVideoAlbums\": {"
        ...
        "}"
    "}",
    "\"PictureLibrary.GetVideoAlbumDetails\": {"
        "\"type\": \"method\","
        "\"description\": \"Retrieve details about a specific album\","
        "\"transport\": \"Response\","
        "\"permission\": \"ReadData\","
    ...
    "}",
      ...
      "\"type\": \"method\","
      "\"description\": \"Add a contact with the given details\","
      "\"transport\": \"Response\","
      "\"permission\": \"UpdateData\","
      "\"params\": ["
                   ...
                   "{ \"name\": \"phones\", \"$ref\": \"Contact.Fields.Phones\" },"
                   "{ \"name\": \"IMs\", \"$ref\": \"Contact.Fields.IMs\" },"
                   "{ \"name\": \"URLs\", \"$ref\": \"Contact.Fields.URLs\" },"
                   "{ \"name\": \"emails\", \"$ref\": \"Contact.Fields.Emails\" },"
                   "{ \"name\": \"home\", \"$ref\": \"Contact.Fields.Address\" },"
                   "{ \"name\": \"work\", \"$ref\": \"Contact.Fields.Address\" },"
                   "{ \"name\": \"other\", \"$ref\": \"Contact.Fields.Address\" },"
                   "{ \"name\": \"relations\", \"$ref\": \"Contact.Fields.Relations\" },"
                   "{ \"name\": \"properties\", \"$ref\": \"Contact.Fields.Contact\" },"
                   "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
                   "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" },"
                   "{ \"name\": \"filter\","
                   "\"type\": ["
                              "{ \"type\": \"object\", \"properties\": { \"contactid\": { \"$ref\": \"Library.Id\", \"required\": true } }, \"additionalProperties\": false },"
                            "{ \"$ref\": \"List.Filter.Contacts\" }"
                  "]"
          "}"
            "],"
        "\"returns\": { \"type\": \"object\","
            "\"properties\": {"
                "\"picturedetails\": { \"$ref\": \"Contact.Details.Contact\" }"
            "}"
       "}"
    "}",
      "\"ContactLibrary.GetContacts\": {"
          "\"type\": \"method\","
          ...
          "\"returns\": {"
              ...
              "\"properties\": {"
                  "\"limits\": { \"$ref\": \"List.LimitsReturned\", \"required\": true },"
                  "\"albums\": { \"type\": \"array\","
                      "\"items\": { \"$ref\": \"Contact.Details.Contact\" }"
                  "}"
              "}"
          "}"
      "}",
      "\"ContactLibrary.GetContactDetails\": {"
          "\"type\": \"method\","
          "\"description\": \"Retrieve details about a specific album\","
          "\"transport\": \"Response\","
          "\"permission\": \"ReadData\","
      ...
      "}",
       ...
       "\"PictureLibrary.GetVideos\": {"
        ...
        "}"
    "}",
    "\"PictureLibrary.GetVideoDetails\": {"
        "\"type\": \"method\","
        "\"description\": \"Retrieve details about a specific picture\","
        "\"transport\": \"Response\","
        "\"permission\": \"ReadData\","
