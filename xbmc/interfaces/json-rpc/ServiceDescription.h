  ...
  "{"
    ...
    "\"Files.GetDirectory\": {"
        ...
        "\"returns\": {"
            ...
            "\"properties\": {"
                ...
                "\"end\": { \"type\": \"integer\", \"minimum\": 0, \"required\": true },"
                "\"total\": { \"type\": \"integer\", \"minimum\": 0, \"required\": true },"
                "\"directories\": { \"$ref\": \"Files.Items\" },"
                "\"files\": { \"$ref\": \"Files.Items\" }"
            "}"
        "}"
    "},"
    "\"AudioLibrary.GetArtists\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.BasicFields\","
    ...
    "\"AudioLibrary.GetAlbums\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Album\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
                    "\"enum\": [ \"album_title\", \"album_description\", \"album_artist\", \"album_genre\","
                                 "\"album_theme\", \"album_mood\", \"album_style\", \"album_type\", \"album_label\"," 
                                 "\"album_rating\", \"year\", \"fanart\" ]"
                "}"
            "},"
            "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
            "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" }"
                ...
                "\"albums\": { \"type\": \"array\","
                    "\"items\": { \"type\": \"object\", \"id\": \"Audio.AlbumDetails\","
                        "\"properties\": {"
                            ...
                            "\"album_genre\": { \"type\": \"string\" },"
                            "\"album_theme\": { \"type\": \"string\" },"
                            "\"album_mood\": { \"type\": \"string\" },"
                            "\"album_style\": { \"type\": \"string\" },"
                            "\"album_type\": { \"type\": \"string\" },"
                            "\"album_label\": { \"type\": \"string\" },"
                            "\"album_rating\": { \"type\": \"integer\" },"
                            "\"year\": { \"type\": \"integer\" }"
                        "}"
                    "}"
                "}"
    ...
    "\"AudioLibrary.GetAlbumDetails\": {"
        ...
        "],"
        "\"returns\": { \"$ref\": \"Audio.AlbumDetails\" }"
    "},"
    "\"AudioLibrary.GetSongs\": {"
        ...
        "\"params\": ["
            ...
            "{ \"name\": \"fields\", \"type\": \"array\", \"id\": \"Library.Fields.Song\","
                "\"items\": { \"type\": \"string\", \"uniqueItems\": true,"
                    "\"enum\": [ \"title\", \"artist\", \"genre\", \"year\", \"rating\", \"album\", \"tracknumber\","
                              "\"discnumber\", \"duration\", \"comment\", \"lyrics\", \"fanart\" ]"
                "}"
            "},"
            "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
            "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" }"
    ...
    "\"AudioLibrary.GetGenres\": {"
        ...
        "\"statechanging\": false,"
        "\"params\": ["
            "{ \"name\": \"fields\", \"$ref\": \"Library.BasicFields\" },"
            "{ \"name\": \"limits\", \"$ref\": \"List.Limits\" },"
            "{ \"name\": \"sort\", \"$ref\": \"List.Sort\" }"
        "],"
        "\"returns\": {"
