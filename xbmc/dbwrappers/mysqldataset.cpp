                           ...
                           compression ? CLIENT_COMPRESS : 0) != nullptr)
    {
      ...
      else if (create_new)
      {
        ...
        snprintf(sqlcmd, sizeof(sqlcmd),
                 "CREATE DATABASE `%s` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci", db.c_str());
...
int MysqlDatabase::copy(const char* backup_name)
{
  ...
  if (res)
  {
    ...
    snprintf(sql, sizeof(sql), "CREATE DATABASE `%s` CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci",
             backup_name);
