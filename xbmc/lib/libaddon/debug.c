...
static mvp_debug_ctx_t addon_debug_ctx = MVP_DEBUG_CTX_INIT("addon",
                                                          ADDON_DBG_NONE,
                                                          NULL);

/*
* addon_dbg_level(int l)
* 
* Scope: PUBLIC
*
* Description
...
addon_dbg_level(int l)
{
  mvp_dbg_setlevel(&addon_debug_ctx, l);
}
...
addon_dbg_all()
{
  mvp_dbg_setlevel(&addon_debug_ctx, ADDON_DBG_ALL);
}
...
addon_dbg_none()
{
  mvp_dbg_setlevel(&addon_debug_ctx, ADDON_DBG_NONE);
}

/*
* addon_dbg()
* 
* Scope: PRIVATE (mapped to __addon_dbg)
* 
* Description
*
...
*/
void
addon_dbg(int level, char *fmt, ...)
{
  va_list ap;

  va_start(ap, fmt);
  mvp_dbg(&addon_debug_ctx, level, fmt, ap);
  va_end(ap);
}
