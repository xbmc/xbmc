...
void CAdvancedSettings::Initialize()
{
  ...
  m_pictureExtensions = ".png|.jpg|.jpeg|.bmp|.gif|.ico|.tif|.tiff|.tga|.pcx|.cbz|.zip|.rss|.webp|."
                        "jp2|.apng|.avif|.heif|.heic";
  ...
  m_archiveExtensions = ".tar.bz2|.tar.gz|.tar.xz|.tgz|.tbz2|.xz|.7z|.bz2|.gz|.tar|.rar|.zip";
