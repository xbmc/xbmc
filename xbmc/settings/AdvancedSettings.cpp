...
void CAdvancedSettings::Initialize()
{
  ...
  m_bCaseSensitiveLocalArtMatch = true; // case sensitive local art matching
...
void CAdvancedSettings::ParseSettingsFile(const std::string &file)
{
  ...
  if (pElement)
  {
    ...
    XMLUtils::GetBoolean(pElement, "casesensitivelocalartmatch", m_bCaseSensitiveLocalArtMatch);
  }
