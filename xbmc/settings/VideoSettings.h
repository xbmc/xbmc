...
enum EINTERLACEMETHOD
{
  ...
  VS_INTERLACEMETHOD_DXVA_ADAPTIVE_LOW=18,
  VS_INTERLACEMETHOD_DXVA_ADAPTIVE_MEDIUM=19,
  VS_INTERLACEMETHOD_DXVA_ADAPTIVE_HIGH=20,
  VS_INTERLACEMETHOD_DXVA_ANY=21,
};
