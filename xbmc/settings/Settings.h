...
public:
  ...
  static const std::string SETTING_POWERMANAGEMENT_SLOWWHENPAUSED;
  static const std::string SETTING_POWERMANAGEMENT_SLOWWHENNOTPLAYING;
  static const std::string SETTING_POWERMANAGEMENT_SLOWGUIIDLETIMEOUT;
  static const std::string SETTING_POWERMANAGEMENT_SLOWGUIFRAMETIME;
