...
const std::string CSettings::SETTING_SERVICES_WEBSERVERENABLECORS = "services.webserverenablecors";
const std::string CSettings::SETTING_SERVICES_WEBSERVERNAME = "services.webservername";
