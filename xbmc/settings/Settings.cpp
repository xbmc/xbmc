...
const std::string CSettings::SETTING_INPUT_RUMBLE_NOTIFY = "input.rumblenotify";
const std::string CSettings::SETTING_INPUT_RUMBLE_DURATION = "input.rumbleduration";
const std::string CSettings::SETTING_INPUT_RUMBLE_STRONG = "input.strongmotor";
const std::string CSettings::SETTING_INPUT_RUMBLE_WEAK = "input.weakmotor";
