...
public:
  ...
  static std::shared_ptr<CResourcesComponent> GetResourcesComponent();
  static void RegisterResourcesComponent(const std::shared_ptr<CResourcesComponent>& resources);
...
private:
  ...
  std::shared_ptr<CResourcesComponent> m_pResourcesComponent;
