...
private:
  ...
  CAspectRatio::ASPECT_RATIO m_aspectRatio; ///< aspect ratio mode of the image
};
...
private:
  ...
  public:
    ...
    CAspectRatio::ASPECT_RATIO GetAspectRatio() const { return m_aspectRatio; }
  ...
  private:
    ...
    CAspectRatio::ASPECT_RATIO m_aspectRatio;
