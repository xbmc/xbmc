...
namespace XFILE
{
    namespace PICTUREDATABASEDIRECTORY
    {
        ...
        typedef enum _NODE_TYPE
        {
            ...
            NODE_TYPE_ALBUM_RECENTLY_ADDED_PICTURES,
            NODE_TYPE_ALBUM_RECENTLY_PLAYED,
            NODE_TYPE_ALBUM_RECENTLY_PLAYED_PICTURES,
            NODE_TYPE_ALBUM_TOP100,
            NODE_TYPE_ALBUM_TOP100_PICTURES,
            NODE_TYPE_ALBUM_COMPILATIONS,
            NODE_TYPE_ALBUM_COMPILATIONS_PICTURES,
            NODE_TYPE_PICTURE,
            NODE_TYPE_PICTURE_TOP100,
            NODE_TYPE_YEAR,
            NODE_TYPE_YEAR_ALBUM,
            NODE_TYPE_YEAR_PICTURE,
            NODE_TYPE_SINGLES
        } NODE_TYPE;
