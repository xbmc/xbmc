...
std::map<string,CDateTime> CRSSDirectory::m_cache;
...
bool CRSSDirectory::ContainsFiles(const string& strPath)
{
  CFileItemList items;
...
static bool IsPathToMedia(const string& strPath )
{
...
static bool IsPathToThumbnail(const string& strPath )
{
...
static time_t ParseDate(const string & strDate)
{
  struct tm pubDate = {0};
...
static void ParseItem(CFileItem* item, SResources& resources, TiXmlElement* root, const string& path);

static void ParseItemMRSS(CFileItem* item, SResources& resources, TiXmlElement* item_child, const string& name, const string& xmlns, const string& path)
{
  ...
  else if(name == "description")
  {
    ...
    if(string(item_child->Attribute("type")) == "html")
  ...
  else if(name == "category")
  {
    ...
    string scheme = item_child->Attribute("scheme");
  ...
  {
    string role = item_child->Attribute("role");
    if     (role == "director")
...
static void ParseItemItunes(CFileItem* item, SResources& resources, TiXmlElement* item_child, const string& name, const string& xmlns, const string& path)
{
  CVideoInfoTag* vtag = item->GetVideoInfoTag();
  string text = item_child->GetText();
...
static void ParseItemRSS(CFileItem* item, SResources& resources, TiXmlElement* item_child, const string& name, const string& xmlns, const string& path)
{
  string text = item_child->GetText();
  if (name == "title")
  {
...
static void ParseItemVoddler(CFileItem* item, SResources& resources, TiXmlElement* element, const string& name, const string& xmlns, const string& path)
{
  CVideoInfoTag* vtag = item->GetVideoInfoTag();
...
static void ParseItemBoxee(CFileItem* item, SResources& resources, TiXmlElement* element, const string& name, const string& xmlns, const string& path)
{
  CVideoInfoTag* vtag = item->GetVideoInfoTag();
  string text = element->GetText();
...
static void ParseItemZink(CFileItem* item, SResources& resources, TiXmlElement* element, const string& name, const string& xmlns, const string& path)
{
  CVideoInfoTag* vtag = item->GetVideoInfoTag();
  string text = element->GetText();
  if     (name == "episode")
...
static void ParseItemSVT(CFileItem* item, SResources& resources, TiXmlElement* element, const string& name, const string& xmlns, const string& path)
{
  string text = element->GetText();
  if     (name == "xmllink")
  {
...
static bool FindMime(SResources resources, string mime)
{
...
static void ParseItem(CFileItem* item, TiXmlElement* root, const string& path)
{
...
bool CRSSDirectory::GetDirectory(const string& path, CFileItemList &items)
{
  string strPath(path);
  URIUtils::RemoveSlashAtEnd(strPath);
  std::map<string,CDateTime>::iterator it;
