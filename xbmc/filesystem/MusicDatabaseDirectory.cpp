  ...
  if (strLabel.empty())
  {
    switch (pNode->GetChildType())
    {
      case NodeType::TOP100:
        strLabel =
            CServiceBroker::GetResourcesComponent()->GetLocalizeStrings().Get(271); // Top 100
        break;
      case NodeType::GENRE:
      ...
      case NodeType::ROLE:
        strLabel =
            CServiceBroker::GetResourcesComponent()->GetLocalizeStrings().Get(38033); // Roles
        break;
      case NodeType::ARTIST:
        strLabel =
            CServiceBroker::GetResourcesComponent()->GetLocalizeStrings().Get(133); // Artists
        break;
      case NodeType::ALBUM:
