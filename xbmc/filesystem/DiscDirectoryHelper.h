...
private:
   ...
   *
   * A single title is the disc's alone. Every version keeps what the heuristics found as well,
   * as a disc can hold an edition under a name the convention does not recognise.
   */
