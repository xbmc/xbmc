...
bool CPVRClient::SignalQuality(PVR_SIGNAL_STATUS &qualityinfo)
{
  if (IsPlayingLiveStream())
  {
    try { return m_pStruct->SignalStatus(qualityinfo) == PVR_ERROR_NO_ERROR; }
    HANDLE_ADDON_EXCEPTION
  }
  return false;
}
...
bool CPVRClient::CanPauseStream(void) const
{
  ...
  if (IsPlaying())
  {
    try { bReturn = m_pStruct->CanPauseStream(); }
    HANDLE_ADDON_EXCEPTION
  }
...
bool CPVRClient::CanSeekStream(void) const
{
  ...
  if (IsPlaying())
  {
    try { bReturn = m_pStruct->CanSeekStream(); }
    HANDLE_ADDON_EXCEPTION
  }
  return bReturn;
}
...
time_t CPVRClient::GetPlayingTime(void) const
{
  ...
  if (IsPlaying())
  {
    try { time = m_pStruct->GetPlayingTime(); }
    HANDLE_ADDON_EXCEPTION
  }
...
time_t CPVRClient::GetBufferTimeStart(void) const
{
  ...
  if (IsPlaying())
  {
    try { time = m_pStruct->GetBufferTimeStart(); }
    HANDLE_ADDON_EXCEPTION
  }
  return time;
}
...
time_t CPVRClient::GetBufferTimeEnd(void) const
{
  ...
  if (IsPlaying())
  {
    try { time = m_pStruct->GetBufferTimeEnd(); }
    HANDLE_ADDON_EXCEPTION
  }
  return time;
}
...
bool CPVRClient::IsRealTimeStream(void) const
{
  ...
  if (IsPlaying())
  {
    try { bReturn = m_pStruct->IsRealTimeStream(); }
    HANDLE_ADDON_EXCEPTION
  }
  return bReturn;
}
