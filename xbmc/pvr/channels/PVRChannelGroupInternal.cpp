...
CPVRChannelGroupInternal::CPVRChannelGroupInternal(bool bRadio) :
  CPVRChannelGroup(bRadio, bRadio ? XBMC_INTERNAL_GROUP_RADIO : XBMC_INTERNAL_GROUP_TV, g_localizeStrings.Get(19286))
{
  m_iHiddenChannels = 0;
...
void CPVRChannelGroupInternal::CheckGroupName(void)
{
  ...
  CStdString strNewGroupName = g_localizeStrings.Get(19286);
