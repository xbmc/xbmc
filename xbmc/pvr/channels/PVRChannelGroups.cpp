...
bool CPVRChannelGroups::LoadUserDefinedChannelGroups(void)
{
  ...
  {
    GetGroupsFromClients();
    CLog::Log(LOGPVR, "CPVRChannelGroups - {0} - {1} new user defined {2} channel groups fetched from clients", __FUNCTION__, (m_groups.size() - iSize), m_bRadio ? "radio" : "TV");
  }
  else
...
bool CPVRChannelGroups::Load(void)
{
  ...
  database->Get(*this);
  CLog::Log(LOGPVR, "CPVRChannelGroups - {0} - {1} {2} groups fetched from the database", __FUNCTION__, m_groups.size(), m_bRadio ? "radio" : "TV");
  ...
  CLog::Log(LOGPVR, "CPVRChannelGroups - {0} - {1} %s channel groups loaded", __FUNCTION__, m_groups.size(), m_bRadio ? "radio" : "TV");
