...
bool CGUIListItem::icompare::operator()(const string &s1, const string &s2) const
{
...
CGUIListItem::CGUIListItem(const string& strLabel)
{
  m_bIsFolder = false;
  m_strLabel2 = "";
  m_strLabel = strLabel;
...
void CGUIListItem::SetLabel(const string& strLabel)
{
...
void CGUIListItem::SetLabel2(const string& strLabel2)
{
...
void CGUIListItem::SetSortLabel(const string &label)
{
...
void CGUIListItem::SetIconImage(const string& strIcon)
{
...
const string& CGUIListItem::GetIconImage() const
{
  return m_strIcon;
}
...
string CGUIListItem::GetOverlayImage() const
{
...
void CGUIListItem::SetProperty(const string &strKey, const CVariant &value)
{
...
CVariant CGUIListItem::GetProperty(const string &strKey) const
{
...
bool CGUIListItem::HasProperty(const string &strKey) const
{
  PropertyMap::const_iterator iter = m_mapProperties.find(strKey);
  if (iter == m_mapProperties.end())
    return false;
...
void CGUIListItem::ClearProperty(const string &strKey)
{
  PropertyMap::iterator iter = m_mapProperties.find(strKey);
  if (iter != m_mapProperties.end())
  {
...
void CGUIListItem::IncrementProperty(const string &strKey, int nVal)
{
...
void CGUIListItem::IncrementProperty(const string &strKey, double dVal)
{
