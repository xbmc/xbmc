...
CBaseTexture *CBaseTexture::LoadFromFile(const string& texturePath, unsigned int idealWidth, unsigned int idealHeight, bool autoRotate, bool requirePixels, const std::string& strMimeType)
{
#if defined(TARGET_ANDROID)
...
bool CBaseTexture::LoadFromFileInternal(const string& texturePath, unsigned int maxWidth, unsigned int maxHeight, bool autoRotate, bool requirePixels, const std::string& strMimeType)
{
