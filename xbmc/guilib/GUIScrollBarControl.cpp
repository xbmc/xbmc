...
GUIScrollBarControl::GUIScrollBarControl(int parentID,
  ...
  : CGUIControl(parentID, controlID, posX, posY, width, height),
    m_guiBackground(CGUITexture::GetTexture(posX, posY, width, height, backGroundTexture)),
    m_guiBarNoFocus(CGUITexture::GetTexture(posX, posY, width, height, barTexture)),
    m_guiBarFocus(CGUITexture::GetTexture(posX, posY, width, height, barTextureFocus)),
    m_guiNibNoFocus(CGUITexture::GetTexture(posX, posY, width, height, nibTexture)),
    m_guiNibFocus(CGUITexture::GetTexture(posX, posY, width, height, nibTextureFocus))
{
...
GUIScrollBarControl::GUIScrollBarControl(const GUIScrollBarControl& left)
  : CGUIControl(left),
    m_guiBackground(CGUITexture::GetTexture(*left.m_guiBackground)),
    m_guiBarNoFocus(CGUITexture::GetTexture(*left.m_guiBarNoFocus)),
    m_guiBarFocus(CGUITexture::GetTexture(*left.m_guiBarFocus)),
    m_guiNibNoFocus(CGUITexture::GetTexture(*left.m_guiNibNoFocus)),
    m_guiNibFocus(CGUITexture::GetTexture(*left.m_guiNibFocus))
{
  m_guiNibNoFocus->SetAspectRatio(CAspectRatio::AR_CENTER);
  m_guiNibFocus->SetAspectRatio(CAspectRatio::AR_CENTER);
  m_numItems = 100;
  ...
  m_pageSize = 10;
  ControlType = GUICONTROL_SCROLLBAR;
  m_orientation = left.m_orientation;
  m_showOnePage = left.m_showOnePage;
}
