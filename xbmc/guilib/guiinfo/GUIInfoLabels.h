...
#define PVR_BACKEND_INSTANCE_NAME         (PVR_STRINGS_START + 76)
#define PVR_STRINGS_END                   PVR_BACKEND_INSTANCE_NAME
...
#define LISTITEM_BACKEND_INSTANCE_NAME (LISTITEM_START + 215)
