...
constexpr uint32_t PLAYER_PROCESS_AUDIO_LIVE_BITRATE = PLAYER_PROCESS_START + 13;
constexpr uint32_t PLAYER_PROCESS_AUDIO_LIVE_KI_BITRATE = PLAYER_PROCESS_START + 14;
constexpr uint32_t PLAYER_PROCESS_AUDIO_LIVE_MI_BITRATE = PLAYER_PROCESS_START + 15;
constexpr uint32_t PLAYER_PROCESS_VIDEO_LIVE_BITRATE = PLAYER_PROCESS_START + 16;
constexpr uint32_t PLAYER_PROCESS_VIDEO_LIVE_KI_BITRATE = PLAYER_PROCESS_START + 17;
constexpr uint32_t PLAYER_PROCESS_VIDEO_LIVE_MI_BITRATE = PLAYER_PROCESS_START + 18;
constexpr uint32_t PLAYER_PROCESS_AUDIO_QUEUE_LEVEL  = PLAYER_PROCESS_START + 19;
constexpr uint32_t PLAYER_PROCESS_AUDIO_QUEUE_DATA_LEVEL = PLAYER_PROCESS_START + 20;
constexpr uint32_t PLAYER_PROCESS_VIDEO_QUEUE_LEVEL  = PLAYER_PROCESS_START + 21;
constexpr uint32_t PLAYER_PROCESS_VIDEO_QUEUE_DATA_LEVEL = PLAYER_PROCESS_START + 22;
