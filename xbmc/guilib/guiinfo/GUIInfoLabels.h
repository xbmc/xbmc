...
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_CHALLENGE_TITLE = 1716;
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_CHALLENGE_BADGE = 1717;
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_INDICATOR_TITLE = 1720;
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_INDICATOR_BADGE = 1721;
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_INDICATOR_PROGRESS = 1722;
constexpr uint32_t RETROPLAYER_ACHIEVEMENTS_INDICATOR_PERCENT = 1723;
