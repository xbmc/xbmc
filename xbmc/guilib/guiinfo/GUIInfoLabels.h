...
constexpr uint32_t LISTITEM_DEFAULT_AUDIO_LANGUAGE   = LISTITEM_START + 228;
constexpr uint32_t LISTITEM_DEFAULT_SUBTITLE_LANGUAGE = LISTITEM_START + 229;
constexpr uint32_t LISTITEM_DEFAULT_AUDIO_CODEC      = LISTITEM_START + 230;
constexpr uint32_t LISTITEM_DEFAULT_AUDIO_CHANNELS   = LISTITEM_START + 231;
