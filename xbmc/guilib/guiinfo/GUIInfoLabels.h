...
constexpr uint32_t LISTITEM_VIDEO_ASPECT_NAME        = LISTITEM_START + 228;
constexpr uint32_t LISTITEM_CONTENT_ASPECT           = LISTITEM_START + 229;
constexpr uint32_t LISTITEM_CONTENT_ASPECT_NAME      = LISTITEM_START + 230;
constexpr uint32_t LISTITEM_CONTENT_ASPECT_COUNT     = LISTITEM_START + 231;
constexpr uint32_t LISTITEM_CONTENT_ASPECT_SOURCE    = LISTITEM_START + 232;
constexpr uint32_t LISTITEM_CONTENT_ASPECT_VARIES    = LISTITEM_START + 233;
