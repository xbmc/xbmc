...
constexpr uint32_t PLAYER_PROCESS_HDR_TYPE           = PLAYER_PROCESS_START + 20;
constexpr uint32_t PLAYER_PROCESS_DOVI_EL_TYPE       = PLAYER_PROCESS_START + 21;
constexpr uint32_t PLAYER_PROCESS_DOVI_L1_MIN        = PLAYER_PROCESS_START + 22;
constexpr uint32_t PLAYER_PROCESS_DOVI_L1_MAX        = PLAYER_PROCESS_START + 23;
constexpr uint32_t PLAYER_PROCESS_DOVI_L1_AVG        = PLAYER_PROCESS_START + 24;
constexpr uint32_t PLAYER_PROCESS_DOVI_L5_LEFT_OFFSET = PLAYER_PROCESS_START + 25;
constexpr uint32_t PLAYER_PROCESS_DOVI_L5_RIGHT_OFFSET = PLAYER_PROCESS_START + 26;
constexpr uint32_t PLAYER_PROCESS_DOVI_L5_TOP_OFFSET = PLAYER_PROCESS_START + 27;
constexpr uint32_t PLAYER_PROCESS_DOVI_L5_BOTTOM_OFFSET = PLAYER_PROCESS_START + 28;
constexpr uint32_t PLAYER_PROCESS_DOVI_L6_MAX_CLL    = PLAYER_PROCESS_START + 29;
constexpr uint32_t PLAYER_PROCESS_DOVI_L6_MAX_FALL   = PLAYER_PROCESS_START + 30;
