...
#define PLAYER_PROCESS_AUDIOCHANNELS_SINK (PLAYER_PROCESS + 13)
...
#define PLAYER_PROCESS_AUDIO_SPK_FL (PLAYER_PROCESS + 150)
#define PLAYER_PROCESS_AUDIO_SPK_FR (PLAYER_PROCESS + 151)
#define PLAYER_PROCESS_AUDIO_SPK_FC (PLAYER_PROCESS + 152)
#define PLAYER_PROCESS_AUDIO_SPK_LFE (PLAYER_PROCESS + 153)
#define PLAYER_PROCESS_AUDIO_SPK_SL (PLAYER_PROCESS + 154)
#define PLAYER_PROCESS_AUDIO_SPK_SR (PLAYER_PROCESS + 155)
#define PLAYER_PROCESS_AUDIO_SPK_BL (PLAYER_PROCESS + 156)
#define PLAYER_PROCESS_AUDIO_SPK_BR (PLAYER_PROCESS + 157)
#define PLAYER_PROCESS_AUDIO_SPK_TFL (PLAYER_PROCESS + 158)
#define PLAYER_PROCESS_AUDIO_SPK_TFR (PLAYER_PROCESS + 159)
#define PLAYER_PROCESS_AUDIO_SPK_TBL (PLAYER_PROCESS + 160)
#define PLAYER_PROCESS_AUDIO_SPK_TBR (PLAYER_PROCESS + 161)

#define PLAYER_PROCESS_AUDIO_SPK_SINK_FL (PLAYER_PROCESS + 170)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_FR (PLAYER_PROCESS + 171)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_FC (PLAYER_PROCESS + 172)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_LFE (PLAYER_PROCESS + 173)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_SL (PLAYER_PROCESS + 174)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_SR (PLAYER_PROCESS + 175)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_BL (PLAYER_PROCESS + 176)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_BR (PLAYER_PROCESS + 177)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_TFL (PLAYER_PROCESS + 178)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_TFR (PLAYER_PROCESS + 179)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_TBL (PLAYER_PROCESS + 180)
#define PLAYER_PROCESS_AUDIO_SPK_SINK_TBR (PLAYER_PROCESS + 181)
