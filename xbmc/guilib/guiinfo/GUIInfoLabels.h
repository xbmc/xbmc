...
#define SLIDESHOW_EXIF_COLORSPACE       (SLIDESHOW_LABELS_START + 7)
...
#define LISTITEM_PICTURE_COLORSPACE       (LISTITEM_START + 64) // => SLIDESHOW_EXIF_COLORSPACE
...
#define LISTITEM_PICTURE_SOFTWARE         (LISTITEM_START + 69) // => SLIDESHOW_EXIF_SOFTWARE
