...
bool CGUIKeyboardFactory::ShowAndGetInput(string& aTextString, const CVariant &heading, bool allowEmptyResult, bool hiddenInput /* = false */, unsigned int autoCloseMs /* = 0 */)
{
...
bool CGUIKeyboardFactory::ShowAndGetInput(string& aTextString, bool allowEmptyResult, unsigned int autoCloseMs /* = 0 */)
{
...
bool CGUIKeyboardFactory::ShowAndGetNewPassword(string& newPassword, const CVariant &heading, bool allowEmpty, unsigned int autoCloseMs /* = 0 */)
{
...
// Shows keyboard and prompts for a password.
// Differs from ShowAndVerifyNewPassword() in that no second verification is necessary.
bool CGUIKeyboardFactory::ShowAndGetNewPassword(string& newPassword, unsigned int autoCloseMs /* = 0 */)
{
  return ShowAndGetNewPassword(newPassword, 12340, false, autoCloseMs);
}

bool CGUIKeyboardFactory::ShowAndGetFilter(string &filter, bool searching, unsigned int autoCloseMs /* = 0 */)
{
...
bool CGUIKeyboardFactory::ShowAndVerifyNewPassword(string& newPassword, const CVariant &heading, bool allowEmpty, unsigned int autoCloseMs /* = 0 */)
{
...
// \return true if successful display and user input entry/re-entry. false if unsuccessful display, no user input, or canceled editing.
bool CGUIKeyboardFactory::ShowAndVerifyNewPassword(string& newPassword, unsigned int autoCloseMs /* = 0 */)
{
  string heading = g_localizeStrings.Get(12340);
...
int CGUIKeyboardFactory::ShowAndVerifyPassword(string& strPassword, const string& strHeading, int iRetries, unsigned int autoCloseMs /* = 0 */)
{
  string strHeadingTemp;
