...
public:
    ...
    : CDirectoryProvider::CSubscriber(invalidate)
  {
    ...
    CServiceBroker::GetRepositoryUpdater().Events().Subscribe(
        this,
        [this](const ADDON::CRepositoryUpdater::RepositoryUpdated& event) { OnEventPublished(); });
  }
...
public:
    ...
    : CDirectoryProvider::CSubscriber(invalidate)
  {
    CServiceBroker::GetFavouritesService().Events().Subscribe(
        this, [this](const CFavouritesService::FavouritesUpdated& event) { OnEventPublished(); });
  }
