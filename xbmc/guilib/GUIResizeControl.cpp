...
CGUIResizeControl::CGUIResizeControl(int parentID,
  ...
  : CGUIControl(parentID, controlID, posX, posY, width, height),
    m_imgFocus(CGUITexture::GetTexture(posX, posY, width, height, textureFocus)),
    m_imgNoFocus(CGUITexture::GetTexture(posX, posY, width, height, textureNoFocus))
{
  m_frameCounter = 0;
  m_lastMoveTime = 0;
  m_fSpeed = 1.0;
...
CGUIResizeControl::CGUIResizeControl(const CGUIResizeControl& left)
  : CGUIControl(left),
    m_imgFocus(CGUITexture::GetTexture(*left.m_imgFocus)),
    m_imgNoFocus(CGUITexture::GetTexture(*left.m_imgNoFocus))
{
  m_frameCounter = 0;
  m_lastMoveTime = 0;
  m_fSpeed = 1.0;
