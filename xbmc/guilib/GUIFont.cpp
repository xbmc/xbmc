...
CScrollInfo::CScrollInfo(unsigned int wait /* = 50 */, float pos /* = 0 */,
  int speed /* = defaultSpeed */, const string &scrollSuffix /* = " | " */)
{
    initialWait = wait;
    initialPos = pos;
...
CGUIFont::CGUIFont(const string& strFontName, uint32_t style, color_t textColor,
