...
public:
  ...
  static void GetRecursiveListing(const std::string& strPath, CFileItemList& items, const std::string& strMask, bool bUseFileDirectories=false);
  static void GetRecursiveDirsListing(const std::string& strPath, CFileItemList& items);
