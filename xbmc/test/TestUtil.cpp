...
const TestDiscData BaseFiles[] = {
    ...
    // Server path tests
    {"\\\\Movies\\Movie\\video_ts\\VIDEO_TS.IFO", ""},
    {"\\\\Movies\\Movie\\disc 1\\video_ts\\VIDEO_TS.IFO", "1"},
    {"\\\\Movies\\Movie\\BDMV\\index.bdmv", ""},
    {"\\\\Movies\\Movie\\disc 1\\BDMV\\index.bdmv", "1"},
    {"\\\\Movies\\Movie\\movie.iso", ""},
    {"\\\\Movies\\Movie\\file.iso", ""},
    {"\\\\Movies\\Movie\\disc 1\\movie.iso", "1"},
    {"\\\\Movies\\Movie\\disc 1\\file.iso", "1"},
    {"\\\\Movies\\Movie\\movie.avi", ""},
    {"\\\\Movies\\Movie\\file.avi", ""},
    {"\\\\Movies\\Movie\\disc 1\\file.avi", "1"},
    {"\\\\Movies\\Movie\\disk 1\\file.avi", "1"},
    {"\\\\Movies\\Movie\\cd 1\\file.avi", "1"},
    {"\\\\Movies\\Movie\\dvd 1\\file.avi", "1"},
    ...
    {"bluray://udf%3a%2f%2f%255c%255csomepath%255cdisc%25201%255cmovie.iso%2f/"
     "BDMV/PLAYLIST/00800.mpls",
     "1"},
    {"zip://%5c%5csomepath%5cdisc%202%5cmovie.zip/BDMV/index.bdmv", "2"},
    {"rar://%5c%5csomepath%5cdisc%203%5cmovie.rar/BDMV/index.bdmv", "3"},
    {"archive://%5c%5csomepath%5cdisc%204%5cmovie.tar.gz/VIDEO_TS/VIDEO_TS.IFO", "4"},
...
const TestRemoveData BasePaths[] = {
    ...
    // Server path tests
    {"\\\\movies\\movie\\video_ts\\", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\disc 1\\video_ts\\", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\BDMV\\", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\disc 1\\BDMV\\index.bdmv", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\file.iso", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\disc 1\\file.iso", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\file.avi", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\disc 1\\file.avi", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\disk 1\\file.avi", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\cd 1\\file.avi", "\\\\movies\\movie\\"},
    {"\\\\movies\\movie\\dvd 1\\file.avi", "\\\\movies\\movie\\"},
    // URL path tests with smb://
    ...
    {"bluray://udf%3a%2f%2f%255c%255csomepath%255cdisc%25201%255cmovie.iso%2f/"
     "BDMV/PLAYLIST/00800.mpls",
     "\\\\somepath\\"},
    {"zip://%5c%5csomepath%5cdisc%202%5cmovie.zip/BDMV/index.bdmv", "\\\\somepath\\"},
    {"rar://%5c%5csomepath%5cdisc%203%5cmovie.rar/BDMV/index.bdmv", "\\\\somepath\\"},
    {"archive://%5c%5csomepath%5cdisc%204%5cmovie.tar.gz/VIDEO_TS/VIDEO_TS.IFO", "\\\\somepath\\"},
    // Embedded URL tests with smb://
    {"bluray://udf%3a%2f%2fsmb%253a%252f%252fsomepath%252fpath%252fdisc%25201%252fmovie.iso%2f/"
     "BDMV/PLAYLIST/00800.mpls",
     "smb://somepath/path/"},
...
const TestBaseData Paths[] = {
    ...
    {"\\\\movies\\movie\\video_ts\\video_ts.ifo", "\\\\movies\\movie\\", "movie"},
    {"\\\\movies\\movie\\disc 1\\video_ts\\video_ts.ifo", "\\\\movies\\movie\\disc 1\\", "movie"},
    {"\\\\movies\\movie\\BDMV\\index.bdmv", "\\\\movies\\movie\\", "movie"},
    {"\\\\movies\\movie\\disc 1\\BDMV\\index.bdmv", "\\\\movies\\movie\\disc 1\\", "movie"},
    {"\\\\movies\\movie\\file.iso", "\\\\movies\\movie\\", "file"},
    {"\\\\movies\\movie\\disc 1\\file.iso", "\\\\movies\\movie\\disc 1\\", "file"},
    // URL path tests with smb://
    ...
    {"archive://D%3a%5csomepath%5cmovie%5cdisc%201%5cmovie.tar.gz/file.mkv",
     "D:\\somepath\\movie\\disc 1\\", "movie"},
    {"bluray://%5c%5csomepath%5cmovie%5c/BDMV/PLAYLIST/00800.mpls", "\\\\somepath\\movie\\",
     "movie"},
    // Embedded windows server path tests
    {"bluray://%5c%5csomepath%5cmovie%5cdisc%201%5c/BDMV/PLAYLIST/00800.mpls",
     "\\\\somepath\\movie\\disc 1\\", "movie"},
    {"zip://%5c%5csomepath%5cmovie%5cmovie.zip/BDMV/PLAYLIST/00800.mpls", "\\\\somepath\\movie\\",
     "movie"},
    {"zip://%5c%5csomepath%5cmovie%5cdisc%201%5cmovie.zip/file.mkv",
     "\\\\somepath\\movie\\disc 1\\", "movie"},
    {"rar://%5c%5csomepath%5cmovie%5cmovie.rar/BDMV/PLAYLIST/00800.mpls", "\\\\somepath\\movie\\",
     "movie"},
    {"rar://%5c%5csomepath%5cmovie%5cdisc%201%5cmovie.rar/file.mkv",
     "\\\\somepath\\movie\\disc 1\\", "movie"},
    {"archive://%5c%5csomepath%5cmovie%5cmovie.tar.gz/BDMV/PLAYLIST/00800.mpls",
     "\\\\somepath\\movie\\", "movie"},
    {"archive://%5c%5csomepath%5cmovie%5cdisc%201%5cmovie.tar.gz/file.mkv",
     "\\\\somepath\\movie\\disc 1\\", "movie"}};
...
constexpr TestMatchingSourceData SourcesToMatch[] = {
    ...
    {"bluray://udf%3a%2f%2fD%253a%255csomepath%255cMovies%255cAlien%2520(1979)%255cmovie.iso%5c/"
     "BDMV/"
     "PLAYLIST/"
     "00800.mpls",
     6},
