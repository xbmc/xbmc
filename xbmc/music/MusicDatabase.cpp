                               ...
                               const std::string& songVideoURL)
{
  ...
  if (strMusicBrainzReleaseTrackID.empty())
    ...
    strSQL += PrepareSQL(", strMusicBrainzReleaseTrackID = '%s'", strMusicBrainzReleaseTrackID.c_str());
  if (strMusicBrainzTrackID.empty())
                                         ...
                                         int offset /* = 0 */) const
{
  ...
  song.strMusicBrainzReleaseTrackID = record->at(offset + song_strMusicBrainzReleaseTrackID).get_asString();
