...
const string& CMusicInfoTag::GetTitle() const
{
  return m_strTitle;
}

const string& CMusicInfoTag::GetURL() const
{
  return m_strURL;
}
...
const string& CMusicInfoTag::GetAlbum() const
{
  return m_strAlbum;
}
...
string CMusicInfoTag::GetYearString() const
{
  return m_dwReleaseDate.wYear ? StringUtils::Format("%i", m_dwReleaseDate.wYear) : StringUtils::Empty;
}

const string &CMusicInfoTag::GetComment() const
{
  return m_strComment;
}

const string &CMusicInfoTag::GetLyrics() const
{
  return m_strLyrics;
}
...
void CMusicInfoTag::SetURL(const string& strURL)
{
  m_strURL = strURL;
}

void CMusicInfoTag::SetTitle(const string& strTitle)
{
  m_strTitle = Trim(strTitle);
}

void CMusicInfoTag::SetArtist(const string& strArtist)
{
  if (!strArtist.empty())
...
void CMusicInfoTag::SetAlbum(const string& strAlbum)
{
...
void CMusicInfoTag::SetAlbumArtist(const string& strAlbumArtist)
{
...
void CMusicInfoTag::SetGenre(const string& strGenre)
{
  if (!strGenre.empty())
...
void CMusicInfoTag::SetComment(const string& comment)
{
  m_strComment = comment;
}

void CMusicInfoTag::SetLyrics(const string& lyrics)
{
  m_strLyrics = lyrics;
}
...
void CMusicInfoTag::SetLastPlayed(const string& lastplayed)
{
...
const string& CMusicInfoTag::GetMusicBrainzTrackID() const
{
...
const string& CMusicInfoTag::GetMusicBrainzAlbumID() const
{
...
const string& CMusicInfoTag::GetMusicBrainzTRMID() const
{
  return m_strMusicBrainzTRMID;
}

void CMusicInfoTag::SetMusicBrainzTrackID(const string& strTrackID)
{
...
void CMusicInfoTag::SetMusicBrainzAlbumID(const string& strAlbumID)
{
...
void CMusicInfoTag::SetMusicBrainzTRMID(const string& strTRMID)
{
...
void CMusicInfoTag::AppendArtist(const string &artist)
{
...
void CMusicInfoTag::AppendAlbumArtist(const string &albumArtist)
{
...
void CMusicInfoTag::AppendGenre(const string &genre)
{
...
string CMusicInfoTag::Trim(const string &value) const
{
