...
public:
  ...
  /* \brief Update the song in the database
   
   Note: This function is used for wrapping the old function used to te new odb functions
   
   \param idSong  the id of the song to update
   \param song the song
   \return true on success
   */
  bool UpdateSong(int idSong, const CSong &song);
  ...
  */
  ...
  /*! \brief Add an album to the database
   ...
   \return the id of the album
   */
  std::shared_ptr<CODBAlbum> AddAlbum(const std::string& strAlbum, const std::string& strMusicBrainzAlbumID,
  ...
  std::shared_ptr<CODBPerson>  AddArtist(const std::string& strArtist, const std::string& strMusicBrainzArtistID);
  bool GetArtist(int idArtist, CArtist& artist, bool fetchAll = true);
  bool GetArtistExists(int idArtist);
  std::shared_ptr<CODBPerson> UpdateArtist(std::shared_ptr<CODBPerson> objPerson,
  ...
  std::shared_ptr<CODBPerson>  AddSongContributor(std::shared_ptr<CODBSong> objSong, const std::string& strRole, const std::string& strArtist);
  void AddSongContributors(std::shared_ptr<CODBSong> objSong, const VECMUSICROLES& contributors);
