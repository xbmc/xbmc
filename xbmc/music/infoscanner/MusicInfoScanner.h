...
protected:
   ...
   */
  bool ResolveMusicBrainz(const CStdString strMusicBrainzID, const ADDON::ScraperPtr &preferredScraper, MUSIC_GRABBER::CMusicInfoScraper &musicInfoScraper, CScraperUrl &musicBrainzURL);
