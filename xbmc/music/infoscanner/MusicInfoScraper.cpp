...
void CMusicInfoScraper::FindAlbumInfo(const string& strAlbum, const string& strArtist /* = "" */)
{
  m_strAlbum=strAlbum;
...
void CMusicInfoScraper::FindArtistInfo(const string& strArtist)
{
  m_strArtist=strArtist;
  m_bSucceeded=false;
  StopThread();
...
void CMusicInfoScraper::LoadArtistInfo(int iArtist, const string &strSearch)
{
  m_iAlbum=-1;
  m_iArtist=iArtist;
...
bool CMusicInfoScraper::CheckValidOrFallback(const string &fallbackScraper)
{
  return true;
/*
