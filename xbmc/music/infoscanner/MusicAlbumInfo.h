...
#ifndef INFOSCANNER_MUSIC_ALBUM_H_INCLUDED
#define INFOSCANNER_MUSIC_ALBUM_H_INCLUDED
...
#ifndef INFOSCANNER_UTILS_SCRAPERURL_H_INCLUDED
#define INFOSCANNER_UTILS_SCRAPERURL_H_INCLUDED
