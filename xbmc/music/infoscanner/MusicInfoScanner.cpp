...
{
  ANNOUNCEMENT::CAnnouncementManager::Get().Announce(ANNOUNCEMENT::AudioLibrary, "kodi", "OnScanStarted");
  try
  {
    if (m_bClean)
    {
  ...
  m_bRunning = false;
  ANNOUNCEMENT::CAnnouncementManager::Get().Announce(ANNOUNCEMENT::AudioLibrary, "kodi", "OnScanFinished");
