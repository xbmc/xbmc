...
CMusicAlbumInfo::CMusicAlbumInfo(const string& strAlbumInfo, const CScraperUrl& strAlbumURL)
{
...
CMusicAlbumInfo::CMusicAlbumInfo(const string& strAlbum, const string& strArtist,
  const string& strAlbumInfo, const CScraperUrl& strAlbumURL)
{
