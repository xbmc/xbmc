...
protected:
  ...
  bool Send(struct sockaddr_in aAddress, LPBYTE pMessage, DWORD dwSize);

  virtual void OnMessage(struct sockaddr_in& aRemoteAddress, const std::string& aMessage, LPBYTE pMessage, DWORD dwMessageLength){};
