...
void CGUIDialogNetworkSetup::UpdateButtons()
{
  ...
  if (addressControl && addressControl->GetControl())
  {
  ...
  if (pathControl && pathControl->GetControl())
  {
  ...
  if (userControl && userControl->GetControl())
  {
  ...
  if (portControl && portControl->GetControl())
  {
  ...
  if (passControl && passControl->GetControl())
  {
  ...
  if (browseControl && browseControl->GetControl())
  {
