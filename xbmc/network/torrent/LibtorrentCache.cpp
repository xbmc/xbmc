...
std::string CLibtorrentCache::GetMetadataPath(const lt::sha1_hash& infoHash) const
{
...
{
  const std::string torrentPath = GetMetadataPath(addTorrentParams.info_hashes.get_best());
