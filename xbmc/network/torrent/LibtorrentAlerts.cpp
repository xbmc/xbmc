      ...
      switch (alert->type())
      {
        case lt::torrent_removed_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "Torrent removed: {}",
                    HashToString(a->info_hashes.get_best()));
        ...
        case lt::read_piece_alert::alert_type:
        {
          ...
          if (a->buffer)
          {
            ...
            m_alertHandler.OnReadPieceFinished(a->handle.info_hash(), static_cast<int>(a->piece),
                                               reinterpret_cast<const uint8_t*>(a->buffer.get()),
                                               a->size);
          }
          else
          {
            ...
            m_alertHandler.OnReadPieceFailed(a->handle.info_hash(), static_cast<int>(a->piece));
          }
        ...
        case lt::file_completed_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "File completed: {} (file index {})",
                    HashToString(a->handle.info_hash()), static_cast<int>(a->index));
        ...
        case lt::file_renamed_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "File renamed: {} (\"{}\" -> \"{}\")",
                    HashToString(a->handle.info_hash()), a->old_name(), a->new_name());
        ...
        case lt::hash_failed_alert::alert_type:
        {
          ...
          CLog::Log(LOGERROR, LOGLIBTORRENT, "Hash failed: {} (piece {})",
                    HashToString(a->handle.info_hash()), static_cast<int>(a->piece_index));
        ...
        case lt::peer_ban_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "Peer banned: {} ({}:{})",
                    HashToString(a->handle.info_hash()), a->endpoint.address().to_string(),
                    a->endpoint.port());
        ...
        case lt::torrent_finished_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "Torrent finished: {}",
                    HashToString(a->handle.info_hash()));
        ...
        case lt::piece_finished_alert::alert_type:
        {
          ...
          m_alertHandler.OnPieceFinished(a->handle.info_hash(), static_cast<int>(a->piece_index));
        ...
        case lt::request_dropped_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "Request dropped: {} (block {}, piece {})",
                    HashToString(a->handle.info_hash()), a->block_index,
        ...
        case lt::storage_moved_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "Storage moved: {} (\"{}\" -> \"{}\")",
                    HashToString(a->handle.info_hash()), a->old_path(), a->storage_path());
        ...
        case lt::metadata_failed_alert::alert_type:
        {
          ...
          m_alertHandler.OnMetadataFailed(a->handle.info_hash());
        ...
        case lt::metadata_received_alert::alert_type:
        {
          ...
          m_alertHandler.OnMetadataReceived(a->handle.info_hash());
        ...
        case lt::dht_get_peers_alert::alert_type:
        {
          ...
          CLog::Log(LOGDEBUG, LOGLIBTORRENT, "DHT get peers: {}", HashToString(a->info_hash));
        ...
        case lt::torrent_error_alert::alert_type:
        {
          ...
          m_alertHandler.OnTorrentError(a->handle.info_hash());
...
std::string CLibtorrentAlerts::HashToString(const lt::sha1_hash& hash)
{
