...
private:
  ...
  void SetResolutionInternal(CSizeInt size, double scale, IShellSurface::StateBitset state, bool sizeIncludesDecoration, bool mustAck = false, std::uint32_t configureSerial = 0u);
  struct Sizes
  {
  ...
  Sizes CalculateSizes(CSizeInt size, double scale, IShellSurface::StateBitset state, bool sizeIncludesDecoration);
  ...
  SizeUpdateInformation UpdateSizeVariables(CSizeInt size, double scale, IShellSurface::StateBitset state, bool sizeIncludesDecoration);
