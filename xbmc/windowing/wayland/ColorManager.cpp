    ...
    const std::string_view sv = [&]
    {
      ...
      switch (feature)
      {
        case icc_v2_v4:
          return "icc_v2_v4"sv;
        case parametric:
          return "parametric"sv;
        case set_primaries:
          return "set_primaries"sv;
        case set_tf_power:
          return "set_tf_power"sv;
        case set_luminances:
          return "set_luminances"sv;
        case set_mastering_display_primaries:
          return "set_mastering_display_primaries"sv;
        case extended_target_volume:
          return "extended_target_volume"sv;
        case windows_scrgb:
          return "windows_scrgb"sv;
        default:
          return "Unknown"sv;
      }
    }();
    ...
    const std::string_view sv = [&]
    {
      ...
      switch (primaries)
      {
        ...
        case ntsc:
          return "ntsc"sv;
        case generic_film:
          return "generic_film"sv;
        case bt2020:
          return "bt2020"sv;
        case cie1931_xyz:
          return "cie1931_xyz"sv;
        case dci_p3:
          return "dci_p3"sv;
        case display_p3:
          return "display_p3"sv;
        case adobe_rgb:
          return "adobe_rgb"sv;
        default:
          return "Unknown"sv;
