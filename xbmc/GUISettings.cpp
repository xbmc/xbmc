...
//  AddGroup(1, 0);
  ...
  AddString(wea, "weather.plugin", 23030, "", SPIN_CONTROL_TEXT, true);
  AddString(wea, "weather.pluginsettings", 23031, "", BUTTON_CONTROL_STANDARD, true);
...
/* hide this from apple users until CoreAudio has been updated to support this */
  ...
  CSettingsCategory* pvrr = AddCategory(8, "pvrplayback", 19043);
