...
CGUISettings::CGUISettings(void)
{
	...
	AddInt(2,"CacheVideo.DVDRom",      14026,  8192, 0, 256, 16384, SPIN_CONTROL_INT_PLUS, MASK_KB);
	...
	AddInt(8,"CacheDVD.DVDRom",        14034, 16384, 0, 256, 16384, SPIN_CONTROL_INT_PLUS, MASK_KB);
	AddInt(9,"CacheDVD.LAN",           14035, 16384, 0, 256, 16384, SPIN_CONTROL_INT_PLUS, MASK_KB);
  ...
  AddBool(2, "PostProcessing.Enable", 286, false);
	...
	AddInt(3, "Filters.RenderMethod", 13354, RENDER_MQ_RGB_SHADER, RENDER_LQ_RGB_SHADER, 1, RENDER_HQ_RGB_SHADER, SPIN_CONTROL_TEXT);
