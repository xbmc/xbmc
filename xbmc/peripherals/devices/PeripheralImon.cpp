...
void CPeripheralImon::AddSetting(const string &strKey, const CSetting *setting, int order)
{
#if !defined(TARGET_WINDOWS)
...
void CPeripheralImon::OnSettingChanged(const string &strChangedSetting)
{
