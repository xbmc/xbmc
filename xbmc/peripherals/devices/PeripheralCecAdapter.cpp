...
void CPeripheralCecAdapter::SetConfigurationFromSettings(void)
{
  ...
  CStdString strWakeDevices = CStdString(GetSettingString("wake_devices_advanced"));
  ...
  CStdString strStandbyDevices = CStdString(GetSettingString("standby_devices_advanced"));
...
void CPeripheralCecAdapter::ReadLogicalAddresses(const CStdString &strString, cec_logical_addresses &addresses)
{
  ...
  {
    CStdString strDevice = CStdString(strString.substr(iPtr, 1));
