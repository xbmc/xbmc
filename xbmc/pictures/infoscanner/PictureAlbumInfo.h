...
{
    class CPictureAlbumInfo
    {
    public:
        CPictureAlbumInfo() : m_bLoaded(false), m_relevance(-1) {}
        CPictureAlbumInfo(const CStdString& strAlbumInfo, const CScraperUrl& strAlbumURL);
        CPictureAlbumInfo(const CStdString& strAlbum, const CStdString& strArtist, const CStdString& strAlbumInfo, const CScraperUrl& strAlbumURL);
        virtual ~CPictureAlbumInfo() {}
