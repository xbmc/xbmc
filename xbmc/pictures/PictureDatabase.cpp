...
bool CPictureDatabase::Exists(const bson *object, int &idObject)
{
  if (!IsValid(object))
    return false;
...
/*
bool CPictureDatabase::IsValid(const bson *object) const
{
...
CFileItem* CPictureDatabase::CreateFileItem(const string &strBson, int id) const
{
  CPictureInfoTag p;
