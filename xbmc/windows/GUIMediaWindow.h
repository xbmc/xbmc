...
#ifndef WINDOWS_VIEW_GUIVIEWCONTROL_H_INCLUDED
#define WINDOWS_VIEW_GUIVIEWCONTROL_H_INCLUDED
...
#ifndef WINDOWS_PLAYLISTS_SMARTPLAYLIST_H_INCLUDED
#define WINDOWS_PLAYLISTS_SMARTPLAYLIST_H_INCLUDED
