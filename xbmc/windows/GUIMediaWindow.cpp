...
bool CGUIMediaWindow::OnClick(int iItem)
{
  ...
  else
  {
    ...
    else if (StringUtils::StartsWith(pItem->GetPath(), "newsmartplaylist://"))
    {
      m_vecItems->RemoveDiscCache(GetID());
    ...
    else if (StringUtils::StartsWith(pItem->GetPath(), "addons://more/"))
    {
...
void CGUIMediaWindow::GetContextButtons(int itemNumber, CContextButtons &buttons)
{
  ...
  if (!item->IsParentFolder() &&
      !item->GetPath().Equals("add") &&
      !item->GetPath().Equals("newplaylist://") &&
      !StringUtils::StartsWith(item->GetPath(), "newsmartplaylist://") &&
      !StringUtils::StartsWith(item->GetPath(), "newtag://") &&
      !StringUtils::StartsWith(item->GetPath(), "addons://more/") &&
