...
public:
   ...
   * \param forceSelection for Blurays, force simple menu to change playlist (default to not)
   * \return True if has success, otherwise false.
   */
  bool Play(const CFileItemPtr& pItem,
            const std::string& player,
            ForcePlaylistSelection forceSelection =
                ForcePlaylistSelection::DONT_FORCE_PLAYLIST_SELECTION);
  ;
