...
if action == 'find':
    ...
    if url == '/path/to/show':
        ...
        liz.addAvailableThumb('DefaultBackFanart.png', '1.78')
        liz.addAvailableThumb('/home/akva/Pictures/hawaii-shirt.png', '2.35')
    ...
    if url == '/path/to/show/guide':
        ...
        liz.addAvailableThumb('/path/to/episode1')
        ...
        liz.addAvailableThumb('/path/to/episode2')
