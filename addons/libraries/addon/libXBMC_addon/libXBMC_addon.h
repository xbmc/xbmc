...
#ifndef _LINUX
#define ADDON_DLL "\addon\libXBMC_addon\libXBMC_addon.dll"
#else
#if defined(__APPLE__)
#if defined(__POWERPC__)
#define ADDON_DLL "/addon/libXBMC_addon/libXBMC_addon-powerpc-osx.so"
#else
#define ADDON_DLL "/addon/libXBMC_addon/libXBMC_addon-x86-osx.so"
#endif
#elif defined(__x86_64__)
#define ADDON_DLL "/addon/libXBMC_addon/libXBMC_addon-x86_64-linux.so"
#elif defined(_POWERPC)
#define ADDON_DLL "/addon/libXBMC_addon/libXBMC_addon-powerpc-linux.so"
#elif defined(_POWERPC64)
#define ADDON_DLL "/addon/libXBMC_addon/libXBMC_addon-powerpc64-linux.so"
#else /* !__x86_64__ && !__powerpc__ */
#define ADDON_DLL "/addon/libXBMC_addon/libXBMC_addon-i486-linux.so"
#endif /* __x86_64__ */
#endif /* _LINUX */
