/*********************************************************************************\
 * xntdll.h
 * "NTDLL" API functions, as defined for the Xbox (there *ARE* differences!!)
 * See comment at bottom for list of error codes
 * (C) 2002 MasterMind
\*********************************************************************************/
...
extern int WINAPI NtSetSystemTime( PFILETIME  SystemTime, PFILETIME PreviousTime );
...
// extern "C" LAUNCH_DATA_PAGE LaunchDataPage;

// XeLoadDashboardImage()
// XeLoadImage@12
// extern "C" HRESULT XeLoadImage( LPCSTR szExePath, DWORD, DWORD );
// XepOpenImageFile( LPCSTR szExePath );
// extern "C" LPCSTR XeImageFileName;
// LdrRelocateImage@20
// XeLoadDashboardImageWithReason@8
// XeLoadDashboardImage()
// HalEnableTrayEjectRequiresReboot(int)
// HalpReboot()
// KeQuickRebootSystem()
//extern "C" LPCSTR XepDashboardRedirectionPath;
...
typedef struct _OBJECT_ATTRIBUTES {
    ...
    PUNICODE_STRING ObjectName; = string
    ULONG Attributes; = ??
...
//DWORD 
//WINAPI 
//HalEnableTrayEjectRequiresReboot( BOOL bEnable );


XBOXAPI 
DWORD 
WINAPI 
XWriteTitleInfoAndRebootA(IN LPCSTR pszLaunchPath,
