...
XBOXAPI LPVOID XepDefaultImagePath;
XBOXAPI LPVOID XepLoaderLock;
XBOXAPI LPVOID XboxHardwareInfo;
XBOXAPI LPVOID KeHasQuickBooted;
XBOXAPI LPVOID ObpDosDevicesDriveLetterMap;
XBOXAPI LPVOID XepDataTableEntry;
XBOXAPI LPVOID FactorySettingsInfo;
XBOXAPI LPVOID UserSettingsInfo;
XBOXAPI LPVOID ExpCdRomBootROMString;
XBOXAPI LPVOID ExpHardDiskBootROMString;
XBOXAPI LPVOID ExpHDXbdmDLL;
XBOXAPI LPVOID ExpDVDXbdmDLL;
XBOXAPI LPVOID XepDashboardRedirectionPath;
XBOXAPI LPVOID XepDashboardImagePath;
XBOXAPI LPVOID ObpIoDevicesDirectoryObject;
XBOXAPI LPVOID ExpCdRomBootROMStringBuffer; // IdexCdRomDeviceNameBuffer;
XBOXAPI LPVOID LaunchDataPage;
// XBOXAPI LPVOID XboxBootFlags;
XBOXAPI LPVOID XeImageFileName;
XBOXAPI LPVOID XboxKrnlVersion;
XBOXAPI LPVOID XboxEEPROMKey;
XBOXAPI LPVOID XboxHDKey;
