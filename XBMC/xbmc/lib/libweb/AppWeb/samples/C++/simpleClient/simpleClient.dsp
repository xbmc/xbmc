...
!MESSAGE 
!MESSAGE NMAKE /f "simpleClient.mak" CFG="simpleClient.mak - Win32"
!MESSAGE 
...
LINK32=link.exe
# ADD BASE LINK32 
# ADD LINK32 -out:.\Release\simpleClient.exe -subsystem:CONSOLE -entry:mainCRTStartup   -machine:x86 -nodefaultlib -incremental:no -nologo    -libpath:"../../../bin" -libpath:"../../../bin/Release"  libappwebStatic.lib ws2_32.lib advapi32.lib user32.lib kernel32.lib oldnames.lib msvcrt.lib


!ENDIF

!IF  "$(CFG)" == "simpleClient - Win32 Debug" 
...
LINK32=link.exe
# ADD BASE LINK32 
# ADD LINK32 -out:.\Debug\simpleClient.exe -subsystem:CONSOLE -entry:mainCRTStartup   -machine:x86 -nodefaultlib -incremental:no -nologo -debug   -libpath:"../../../bin" -libpath:"../../../bin/Debug"  libappwebStatic.lib ws2_32.lib advapi32.lib user32.lib kernel32.lib oldnames.lib msvcrt.lib
