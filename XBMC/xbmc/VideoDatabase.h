...
public:
  ...
  void UpdateMovieTitle(long lMovieId, const CStdString& strNewMovieTitle, CONTENT_TYPE iType=CONTENT_MOVIES);
  ...
  void GetFilePathById(long id, CStdString &filePath, CONTENT_TYPE iType);
...
protected:
  ...
  CVideoInfoTag GetDetailsByTypeAndId(CONTENT_TYPE type, long id);
