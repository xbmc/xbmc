...
class LibAvCodecInterface
{
public:
  virtual ~LibAvCodecInterface() {}
...
class LibAvCodec : public DllDynamic, LibAvCodecInterface
{
public:
...
class LibAvCodec : public DllDynamic, LibAvCodecInterface
{
  DECLARE_DLL_WRAPPER(LibAvCodec, DLL_PATH_LIBAVCODEC)
#ifndef _LINUX
...
public:
    ...
    {
      CSingleLock lock(LibAvCodec::m_critSection);
