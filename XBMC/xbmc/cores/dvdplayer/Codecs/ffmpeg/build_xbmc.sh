...
./configure --extra-cflags="-D_XBOX" --enable-shared --enable-postproc --enable-gpl --disable-static --disable-vhook --enable-swscale --enable-protocol=http --disable-altivec --disable-ipv6 --enable-pthreads --disable-debug --enable-encoder=ac3
