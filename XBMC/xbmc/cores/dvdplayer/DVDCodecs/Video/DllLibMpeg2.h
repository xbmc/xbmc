...
public:
  ...
  virtual int mpeg2_guess_aspect (const mpeg2_sequence_t * sequence, unsigned int * pixel_width, unsigned int * pixel_height)=0;
...
class DllLibMpeg2 : public DllDynamic, DllLibMpeg2Interface
{
  ...
  DEFINE_METHOD3(int, mpeg2_guess_aspect, (const mpeg2_sequence_t * p1, unsigned int * p2, unsigned int * p3))
  ...
  BEGIN_METHOD_RESOLVE()
    ...
    RESOLVE_METHOD(mpeg2_guess_aspect)
