...
Export export_winsockx[] =
{
#ifdef _XBOX
  { "WSACleanup",                   116, WSACleanup,                    NULL },
  { "WSAGetLastError",               -1, WSAGetLastError,               NULL },
  { "WSASetLastError@4",             -1, WSASetLastError,               NULL },
  { "bind@12",                       -1, dllbind,                       NULL },
  { "closesocket@4",                 -1, dllclosesocket,                NULL },
  { "connect@12",                    -1, dllconnect,                    NULL },
  { "htonl@4",                       -1, htonl,                         NULL },
  { "htons@4",                       -1, htons,                         NULL },
  { "inet_addr@4",                   -1, inet_addr,                     NULL },
  { "inet_ntoa",                     12, dllinet_ntoa,                  NULL },
  { "ioctlsocket@12",                -1, dllioctlsocket,                NULL },
  { "ntohl@4",                       -1, ntohl,                         NULL },
  { "recv@16",                       -1, dllrecv,                       NULL },
  { "select@20",                     -1, dllselect,                     NULL },
  { "send@16",                       -1, dllsend,                       NULL },
  { "sendto",                        20, dllsendto,                     NULL },
  { "setsockopt@20",                 -1, dllsetsockopt,                 NULL },
  { "socket@12",                     -1, dllsocket,                     NULL },
  { "accept@12",                     -1, dllaccept,                     NULL },
  { "gethostname@12",                -1, dllgethostname,                NULL },
  { "getsockname@12",                -1, dllgetsockname,                NULL },
  { "listen@8",                      -1, dlllisten,                     NULL },
  { "__WSAFDIsSet@8",                -1, __WSAFDIsSet,                  NULL },  //don't use emu, cause problems
  { "WSACreateEvent@0",              -1, WSACreateEvent,                NULL },
  { "getpeername@12",                -1, dllgetpeername,                NULL },
  { "XNetDnsRelease@4",              -1, XNetDnsRelease,                NULL },
  { "XNetDnsLookup@12",              -1, XNetDnsLookup,                 NULL },
  { "XNetRandom@8",                  -1, XNetRandom,                    NULL },
#endif
  { NULL,                          NULL, NULL,                          NULL }
};
#endif
