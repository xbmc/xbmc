...
static ssize_t radeon_vid_read(struct file *file, char *buf, size_t count, l__int64 *ppos)
{
    uint32_t size;
...
static ssize_t radeon_vid_write(struct file *file, const char *buf, size_t count, l__int64 *ppos)
{
#ifdef RAGE128
