...
{
	video_out_directx.info=pFunctions->info;
	video_out_directx.preinit=pFunctions->preinit;
	video_out_directx.config=pFunctions->config;
	video_out_directx.control=pFunctions->control;
	video_out_directx.draw_frame=pFunctions->draw_frame;
	video_out_directx.draw_slice=pFunctions->draw_slice;
	video_out_directx.draw_osd=pFunctions->draw_osd;
	video_out_directx.flip_page=pFunctions->flip_page;
