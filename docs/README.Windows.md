...
* Under **Desktop & Mobile** section select
  * `Desktop development with C++`
    * Select in Optional section `Windows 11 SDK (10.0.22621.0)`
  * `WinUI application development` (if compiling for UWP)
    * Select in Optional section `Universal Windows Platform tools`
    * Select in Optional section `C++ (v143) Universal Windows Platform tools`
