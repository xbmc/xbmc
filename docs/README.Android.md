...
## 3. Prerequisites
Building Kodi for Android requires Android NDK revision 26c (26.2.11394342). For the SDK just use the latest available.
...
--with-ndk-path=<path>
```
  specify path to ndk (optional for android), default is sdk_path/ndk/26.2.11394342
