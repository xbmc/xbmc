...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang")
    add_options(CXX DEBUG "-Wno-overloaded-virtual")
  endif()
endif()

if((CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND (CMAKE_CXX_COMPILER_VERSION VERSION_EQUAL 3.5 OR CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 3.5)) OR (CMAKE_CXX_COMPILER_ID STREQUAL "AppleClang" AND (CMAKE_CXX_COMPILER_VERSION VERSION_EQUAL 7 OR CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 7)))
  add_options(CXX "DEBUG;RELEASE" "-Wno-inconsistent-missing-override")
endif()
