...
# Macro to check if a given type exists
# Arguments:
...
macro(check_type type var)
  ...
  check_type_size(${type} ${var} LANGUAGE CXX)
...
check_type(char16_t HAVE_CHAR16_T)
check_type(char32_t HAVE_CHAR32_T)
check_type(std::u16string HAVE_STD__U16_STRING)
check_type(std::u32string HAVE_STD__U32_STRING)
check_type(uint_least16_t HAVE_STDINT_H)
