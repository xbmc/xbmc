...
macro (build_addon target prefix libs)
  ...
  if(PACKAGE_ZIP OR PACKAGE_TGZ)
    ...
    if(OSX_CODE_SIGN_IDENTITY)
      list(APPEND CODESIGN_BINARIES ${LIBRARY_LOCATION})
      if(${prefix}_ADDITIONAL_BINARY)
        list(APPEND CODESIGN_BINARIES ${${prefix}_ADDITIONAL_BINARY})
      endif()
      if(${prefix}_ADDITIONAL_BINARY_EXE)
        list(APPEND CODESIGN_BINARIES ${${prefix}_ADDITIONAL_BINARY_EXE})
      endif()
      if(${prefix}_ADDITIONAL_BINARY_DIRS)
        foreach(binary ${${prefix}_ADDITIONAL_BINARY_DIRS})
          list(APPEND CODESIGN_BINARIES ${binary})
        endforeach()
      endif()

      add_custom_target(osx-codesign
                        codesign -vvvv -s ${OSX_CODE_SIGN_IDENTITY} ${CODESIGN_BINARIES})
      add_dependencies(addon-package osx-codesign)
    endif()
  else()
