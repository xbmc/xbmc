...
if(CORE_SYSTEM_NAME STREQUAL android)
  if (CPU MATCHES "v7a")
    set(PLATFORM_TAG ${CORE_SYSTEM_NAME}-armv7)
  elseif (CPU MATCHES "arm64")
    set(PLATFORM_TAG ${CORE_SYSTEM_NAME}-aarch64)
  elseif (CPU MATCHES "i686")
    set(PLATFORM_TAG ${CORE_SYSTEM_NAME}-i686)
  else()
    message(FATAL_ERROR "Unsupported architecture")
  endif()
elseif(CORE_SYSTEM_NAME STREQUAL darwin_embedded)
  # Use CORE_PLATFORM_NAME instead of CORE_SYSTEM_NAME to keep ios and tvos
  # separate.
  if (CPU MATCHES armv7)
    set(PLATFORM_TAG ${CORE_PLATFORM_NAME}-armv7)
  elseif (CPU MATCHES arm64)
    set(PLATFORM_TAG ${CORE_PLATFORM_NAME}-aarch64)
  else()
    message(FATAL_ERROR "Unsupported architecture")
  endif()
elseif(CORE_SYSTEM_NAME STREQUAL osx)
  set(PLATFORM_TAG ${CORE_SYSTEM_NAME}-${CPU})
elseif(CORE_SYSTEM_NAME STREQUAL windows)
  ...
  if(_X86_)
    set(PLATFORM_TAG ${CORE_SYSTEM_NAME}-i686)
  elseif(_AMD64_)
    set(PLATFORM_TAG ${CORE_SYSTEM_NAME}-x86_64)
  else()
    message(FATAL_ERROR "Unsupported architecture")
  endif()
