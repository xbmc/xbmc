...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  if(PCRE2_FOUND)
    if(TARGET PCRE2::8BIT AND NOT TARGET ${${CMAKE_FIND_PACKAGE_NAME}_SEARCH_NAME})
      get_target_property(_pcre2_8bit_is_aliased_target PCRE2::8BIT ALIASED_TARGET)
      if (_pcre2_8bit_is_aliased_target)
        add_library(${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME} ALIAS ${_pcre2_8bit_is_aliased_target})
      else()
