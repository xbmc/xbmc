...
find_library(PYTHON_LIBRARY NAMES python3.7 python3.6 python3.5 HINTS ${DEPENDS_DIR}/lib)
find_path(PYTHON_INCLUDE_DIR NAMES Python.h HINTS ${DEPENDS_DIR}/include PATH_SUFFIXES python3.7 python3.6 python3.5)
...
if(KODI_DEPENDSBUILD)
  ...
  list(APPEND PYTHON_LIBRARIES ${PYTHON_LIBRARY})
endif()
