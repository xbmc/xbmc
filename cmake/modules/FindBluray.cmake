...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  macro(buildmacroBluray)
    ...
    set(CONFIGURE_COMMAND ${configure_env_mod}
                          ${MESON_EXECUTABLE} setup ./build
                          --cmake-prefix-path=['${DEPENDS_PATH}/lib/cmake']
                          --prefix=${DEPENDS_PATH}
                          --libdir=lib
                          --buildtype=release
                          -Ddefault_library=${libbuildtype}
                          -Denable_tools=false
                          -Dembed_udfread=false
                          ${CROSS_FILE})

    set(BUILD_COMMAND ${build_env_mod}
  ...
  if(ENABLE_INTERNAL_BLURAY)
    ...
    set(${CMAKE_FIND_PACKAGE_NAME}_DEPLIST Iconv
                                           Udfread)
