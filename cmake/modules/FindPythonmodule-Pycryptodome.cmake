...
if(NOT TARGET Python::Pycryptodome)
  ...
  macro(buildPythonmodulePycryptodome)
  ...
  if(PYCRYPTO_VER VERSION_LESS ${${MODULE}_VER})
    ...
    if(_multiconfig_generator)
      buildPythonmodulePycryptodome()
      set_target_properties(pythonmodule-pycryptodome PROPERTIES EXCLUDE_FROM_ALL TRUE)

      add_dependencies(build_internal_depends pythonmodule-pycryptodome)
    endif()
  endif()
endif()
