...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  if(Cdio_FOUND)
    ...
    if(PKG_CONFIG_FOUND AND NOT (WIN32 OR WINDOWS_STORE))
      pkg_check_modules(PC_ISO9660PP libiso9660++${PC_${CMAKE_FIND_PACKAGE_NAME}_FIND_SPEC} QUIET)
      pkg_check_modules(PC_ISO9660 libiso9660${PC_${CMAKE_FIND_PACKAGE_NAME}_FIND_SPEC} QUIET)
    endif()
