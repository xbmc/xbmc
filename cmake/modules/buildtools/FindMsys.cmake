...
if (WIN32)
  ...
  get_filename_component(MSYS_INSTALL_PATH "${MSYS_CMD}" DIRECTORY CACHE)

  # Provide standardized success/failure messages
  include(FindPackageHandleStandardArgs)
  find_package_handle_standard_args(Msys
                                    FAIL_MESSAGE "Msys was not found. Run download-msys2.bat to install the Msys environment"
                                    REQUIRED_VARS MSYS_INSTALL_PATH)
