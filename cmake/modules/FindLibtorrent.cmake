...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  macro(buildLibtorrent)
    ...
    if(WINDOWS_STORE)
      list(APPEND patches "${CORE_SOURCE_DIR}/tools/depends/target/${MODULE_LC}/0003-Disable-Win32-file-API-in-Boost.patch")
    endif()
    ...
    add_dependencies(${MODULE_LC} ${APP_NAME_LC}::Boost
