...
if(ENABLE_INTERNAL_FFMPEG)
  ...
  if(FFMPEG_FOUND)
    ...
    if(KODI_DEPENDSBUILD)
      message(WARNING "FFmpeg ${REQUIRED_FFMPEG_VERSION} not found, consider explicitly using -DENABLE_INTERNAL_FFMPEG=ON. Internal FFMPEG will be built")
      buildFFMPEG()
    else()
