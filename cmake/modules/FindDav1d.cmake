...
if(NOT TARGET LIBRARY::${CMAKE_FIND_PACKAGE_NAME})
  ...
  macro(buildmacroDav1d)
    ...
    if(EXISTS ${DEPENDS_PATH}/share/${${CMAKE_FIND_PACKAGE_NAME}_MODULE_LC}-cross-file.meson)
      set(CROSS_FILE --cross-file=${DEPENDS_PATH}/share/${${CMAKE_FIND_PACKAGE_NAME}_MODULE_LC}-cross-file.meson)
    ...
    set(CONFIGURE_COMMAND ${CMAKE_COMMAND} -E env --modify NINJA=set:${NINJA_EXECUTABLE}
    ...
    set(BUILD_COMMAND Ninja::Ninja -C ./build)
    set(INSTALL_COMMAND Ninja::Ninja -C ./build install)
