...
if(NOT TARGET ${APP_NAME_LC}::${CMAKE_FIND_PACKAGE_NAME})
  ...
  macro(buildexiv2)
    ...
    # Exiv2 cant be built using /RTC1
    string(REPLACE "/RTC1" "" EXIV2_CXX_FLAGS ${CMAKE_CXX_FLAGS} )

    set(CMAKE_ARGS "-DCMAKE_CXX_FLAGS=${EXIV2_CXX_FLAGS} $<$<CONFIG:Debug>:${CMAKE_CXX_FLAGS_DEBUG}> $<$<CONFIG:Release>:${CMAKE_CXX_FLAGS_RELEASE}>" 
