...
#define PLEX_METADATA_CHANNEL_VIDEO 121
#define PLEX_METADATA_CHANNEL_MUSIC 122
#define PLEX_METADATA_CHANNEL_PHOTO 123
#define PLEX_METADATA_CHANNEL_APPLICATION 124

#define PLEX_METADATA_GLOBAL_IMAGES 999
