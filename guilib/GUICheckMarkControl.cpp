...
void CGUICheckMarkControl::UpdateColors(bool &changed)
{
  changed = m_imgCheckMark.SetDiffuseColor(m_diffuseColor)        || changed;
  changed = m_imgCheckMarkNoFocus.SetDiffuseColor(m_diffuseColor) || changed;
