...
void CGUIRadioButtonControl::UpdateColors(bool &changed)
{
  changed = m_imgRadioOn.SetDiffuseColor(m_diffuseColor) || changed;
  changed = m_imgRadioOff.SetDiffuseColor(m_diffuseColor) || changed;
