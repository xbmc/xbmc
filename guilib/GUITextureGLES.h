...
public:
  ...
  static void DrawQuad(const XbmcCRect &rect, DWORD color);
protected:
  void Begin();
  void Draw(float *x, float *y, float *z, const XbmcCRect &texture, const XbmcCRect &diffuse, DWORD color, int orientation);
  void End();
};
