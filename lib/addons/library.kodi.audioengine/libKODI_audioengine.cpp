...
#include "addons/binary/callbacks/AudioEngine/api-level-1/AddonCallbacksAudioEngine.h"
...
using namespace AudioEngineLIB::V1;
...
DLLEXPORT void* AudioEngine_register_me(void *hdl)
{
  ...
  {
    cb = (AudioEngineLIB::V1::CB_AudioEngineLib*)((AddonCB*)hdl)->AudioEngineLib_RegisterMe(((AddonCB*)hdl)->addonData);
    if (!cb)
