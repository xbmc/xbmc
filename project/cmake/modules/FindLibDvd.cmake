...
if(NOT WIN32)
  if(CMAKE_CROSSCOMPILING)
    if(PKG_CONFIG_FOUND)
      pkg_check_modules(PC_DVD ${dvdlibs} QUIET)
      #pkg_check_modules(PC_DVD libdvdread libdvdnav libdvdcss)
    endif()
 
    find_path(LIBDVD_INCLUDE_DIR dvdcss/dvdcss.h PATHS ${PC_DVD_INCLUDE_DIRS})
    find_library(DVDREAD_LIBRARY NAMES dvdread libdvdread PATHS ${PC_DVD_libdvdread_LIBDIR})
    find_library(DVDNAV_LIBRARY NAMES dvdnav libdvdnav PATHS ${PC_DVD_libdvdnav_LIBDIR})
    find_library(DVDCSS_LIBRARY NAMES dvdcss libdvdcss PATHS ${PC_DVD_libdvdcss_LIBDIR})

    include(FindPackageHandleStandardArgs)
    find_package_handle_standard_args(LIBDVD REQUIRED_VARS LIBDVD_INCLUDE_DIR DVDREAD_LIBRARY DVDNAV_LIBRARY DVDCSS_LIBRARY)
    if(LIBDVD_FOUND)
      set(LIBDVD_LIBRARIES ${DVDREAD_LIBRARY} ${DVDNAV_LIBRARY} ${DVDREAD_LIBRARY})
      ...
      mark_as_advanced(LIBDVD_INCLUDE_DIR LIBDVD_LIBRARIES)
