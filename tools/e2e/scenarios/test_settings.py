...
def test_setting_value_roundtrip(kodi: KodiInstance):
    ...
    # itself rather than leaving it to the fixture: the read-back above is served by the
    # same running instance that accepted the write, so it holds even if the setting
    # never reaches guisettings.xml.
