...
rem Remove -prerelease to NOT find installed prerelease versions of the latest installed version of Visual Studio
FOR /f "usebackq tokens=1* delims=" %%i in (`%vswhere% -latest -property installationPath -prerelease`) do (
